...
export const kinguProfileFindProjectProfiles: Mock = vi.fn()
...
export function installReposRuntimeRoutingHarness(): void {
  beforeEach(() => {
    ...
    ptyKill.mockReset()
    kinguProfileFindProjectProfiles.mockReset()
    ...
    vi.stubGlobal('window', {
      api: {
        ...
        kinguProfiles: {
          findProjectProfiles: kinguProfileFindProjectProfiles
        },
        pty: { kill: ptyKill },
