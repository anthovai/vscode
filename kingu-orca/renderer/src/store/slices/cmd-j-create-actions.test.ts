...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __KINGU_WEB_CLIENT__?: boolean }).__KINGU_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __KINGU_WEB_CLIENT__?: boolean }
