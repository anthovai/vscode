  ...
  it('groups hydrated VM project setups under the repo-derived project identity', () => {
    ...
    const projects = [
      {
        ...
        displayName: 'kingu',
        badgeColor: '#737373',
        sourceRepoIds: ['local-kingu'],
        createdAt: 1,
        updatedAt: 1
      },
      {
        id: 'repo:vm-kingu',
        displayName: 'vercel/sandbox/kingu',
        badgeColor: '#737373',
        sourceRepoIds: ['vm-kingu'],
        createdAt: 1,
        updatedAt: 1
      }
    ]
    ...
    expect(projection.setups).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({ id: 'vm-setup', projectId: 'github:anthovai/kingu-intelligence' })
      ])
    )
  })
