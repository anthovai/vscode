...
import { KINGU_EDITOR_REQUEST_FILE_CLOSE_EVENT } from '@/components/editor/editor-autosave'
...
describe('tab-strip close of a client-dirty mirrored file after a host republish (#21392)', () => {
  ...
  beforeEach(() => {
    ...
    window.addEventListener(KINGU_EDITOR_REQUEST_FILE_CLOSE_EVENT, onCloseRequest)
  ...
  afterEach(() => {
    window.removeEventListener(KINGU_EDITOR_REQUEST_FILE_CLOSE_EVENT, onCloseRequest)
