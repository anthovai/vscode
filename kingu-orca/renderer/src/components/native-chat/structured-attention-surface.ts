...
import { isKinguWindowForegroundFocused } from '../terminal-pane/terminal-notification-pane-visibility'
...
function isViewedStructuredTab(
  ...
  if (!isKinguWindowForegroundFocused() || state.activeWorktreeId !== workspaceId) {
    return false
  }
