...
function failedText(count: number): SegmentText {
  return {
    ...
    tooltip: translate(
      ...
      'Chats Kingu could not resume after the restart. Click for details.'
    )
  }
}
...
function checkText(count: number): SegmentText {
  return {
    ...
    tooltip: translate(
      ...
      'Chats Kingu couldn’t resume, or couldn’t confirm it resumed, after the restart. Click for details.'
    )
  }
}
