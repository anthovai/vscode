...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--kingu-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--kingu-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--kingu-terminal-overlay-probe width)')
