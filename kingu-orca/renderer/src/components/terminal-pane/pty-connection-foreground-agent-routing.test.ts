...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when an Kingu-started command exits', async () => {
  ...
  it('confirms an Kingu-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {
