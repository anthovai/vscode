...
describe('handleOscLink', () => {
  it('opens local .html file paths in Kingu browser tabs with the platform modifier', async () => {
  ...
  it('also opens local .htm paths in Kingu browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file paths in Kingu and reveals default column 1 with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('preserves explicit column for Kingu opens from :line:column links', async () => {
    setPlatform('Macintosh')
  ...
  it('falls back to Kingu when shift+cmd/ctrl-click system default open fails', async () => {
    setPlatform('Macintosh')
  ...
  it('ignores stale async completion so latest local click wins for Kingu open and reveal', async () => {
    setPlatform('Macintosh')
