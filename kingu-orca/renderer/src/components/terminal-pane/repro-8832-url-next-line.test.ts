...
const LINE_1 = 'Repo: https://github.com/anthovai/kingu-intelligence/'
const LINE_2 = 'Description: 123'
const EXPECTED_URL = 'https://github.com/anthovai/kingu-intelligence/'
const BUGGY_URL = 'https://github.com/anthovai/kingu-intelligence/Description'
...
describe('#8832 hard-wrapped path candidates glue next-line text into URLs', () => {
  ...
  it('still builds a multi-row path candidate that concatenates Description onto the URL', () => {
    ...
    expect(glued!.text).toContain('https://github.com/anthovai/kingu-intelligence/Description')
  })
  ...
  it.each([
    ...
    ['POSIX path', '/usr/local/bin/kingu'],
