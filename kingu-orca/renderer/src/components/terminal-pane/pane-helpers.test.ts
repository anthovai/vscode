...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\kingu\\file.txt', 'windows')).toBe(
      'C:\\Users\\kingu\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\kingu\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\kingu\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\kingu\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\kingu\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.kingu/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.kingu/drops/my file'\\''s $draft.txt'"
    )
  })
})
