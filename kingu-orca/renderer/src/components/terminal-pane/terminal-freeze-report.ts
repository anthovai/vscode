// One-paste freeze report: `await window.__kinguTerminalFreezeReport()` in the
...
type TerminalFreezeReportWindow = Window & {
  __kinguTerminalFreezeReport?: () => Promise<TerminalFreezeReport>
}
...
export function installTerminalFreezeReport(): void {
  ...
  ;(window as TerminalFreezeReportWindow).__kinguTerminalFreezeReport = buildTerminalFreezeReport
}
