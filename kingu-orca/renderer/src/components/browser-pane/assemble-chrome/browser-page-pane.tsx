...
export function BrowserPagePane({
  ...
  const isBlankTab = browserTab.url === 'about:blank' || browserTab.url === KINGU_BROWSER_BLANK_URL
      ...
      {pageViewport?.container
        ? createPortal(
            <BrowserPageViewportOverlays
              ...
              sshRouted={Boolean(sessionPartition?.startsWith('persist:kingu-browser-v1-'))}
              isBlankTab={isBlankTab}
