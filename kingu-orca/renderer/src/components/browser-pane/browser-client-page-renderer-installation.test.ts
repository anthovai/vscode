...
describe('browser client page renderer installation', () => {
  afterEach(() => {
    delete (window as unknown as { __KINGU_WEB_CLIENT__?: boolean }).__KINGU_WEB_CLIENT__
  })
  ...
  it('stays inert in the paired web client', () => {
    ;(window as unknown as { __KINGU_WEB_CLIENT__?: boolean }).__KINGU_WEB_CLIENT__ = true
