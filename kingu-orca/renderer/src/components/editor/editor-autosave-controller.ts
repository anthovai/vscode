import {
  ...
  KINGU_EDITOR_EXTERNAL_FILE_CHANGE_EVENT,
  KINGU_EDITOR_QUIESCE_FILE_SAVES_EVENT,
  KINGU_EDITOR_SAVE_AND_CLOSE_EVENT,
  KINGU_EDITOR_SAVE_FILE_EVENT,
...
import {
  ...
  KINGU_EDITOR_SAVE_DIRTY_FILES_EVENT
...
export function attachEditorAutosaveController(store: AppStoreApi): () => void {
  ...
  window.addEventListener(KINGU_EDITOR_SAVE_AND_CLOSE_EVENT, handleSaveAndClose as EventListener)
  window.addEventListener(KINGU_EDITOR_SAVE_FILE_EVENT, handleSaveFile as EventListener)
  window.addEventListener(KINGU_EDITOR_QUIESCE_FILE_SAVES_EVENT, handleQuiesce as EventListener)
  window.addEventListener(
    KINGU_EDITOR_EXTERNAL_FILE_CHANGE_EVENT,
  ...
  return () => {
    ...
    window.removeEventListener(KINGU_EDITOR_SAVE_FILE_EVENT, handleSaveFile as EventListener)
    window.removeEventListener(
      KINGU_EDITOR_QUIESCE_FILE_SAVES_EVENT,
