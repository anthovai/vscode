...
// Mac-style terminal traffic-light dots — the signature of an Kingu terminal pane.
...
// Use Kingu's browser: a browser pane with a cursor grabbing one highlighted
