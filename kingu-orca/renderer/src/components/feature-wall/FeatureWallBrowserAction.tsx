...
// needs the Kingu CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the Kingu CLI and browser skill, so offer the same
// install action the Enable Kingu CLI step uses, scoped to just browser use.
