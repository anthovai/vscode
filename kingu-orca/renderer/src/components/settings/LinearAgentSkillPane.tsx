...
import { KINGU_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Kingu: browse issues, start linked workspaces, and let agents update tickets with /kingu-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${KINGU_LINEAR_SKILL_NAME}`}
      />
