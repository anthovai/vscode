...
const KINGU_IOS_APP_STORE_URL = 'https://apps.apple.com/app/kingu-ide/id6766130217'
const KINGU_ANDROID_APK_URL =
  'https://github.com/anthovai/kingu-intelligence/releases/download/mobile-android-v0.0.48/app-release.apk'
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Kingu Mobile from the'
            )}{' '}
            <button
              type="button"
              onClick={() => void window.api.shell.openUrl(KINGU_IOS_APP_STORE_URL)}
            ...
            <button
              ...
              onClick={() => void window.api.shell.openUrl(KINGU_ANDROID_APK_URL)}
              className="cursor-pointer underline underline-offset-2 hover:text-foreground"
            >
              {translate(
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Kingu Mobile shortcut in the sidebar.'
          )}
