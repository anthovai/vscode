...
function getInstallDescription(platform: string): string {
  if (platform === 'darwin') {
    return 'Register `kingu` in /usr/local/bin.'
  }
  if (platform === 'linux') {
    return 'Register `kingu-ide` in ~/.local/bin.'
  }
  if (platform === 'win32') {
    return 'Register `kingu` in your user PATH.'
  }
...
export function CliSection({
  ...
  } = useInstalledAgentSkill(KINGU_CLI_SKILL_NAME, {
    ...
    <section className="space-y-4" data-settings-section="cli">
      <div className="space-y-1">
        <h2 className="text-sm font-semibold">
          {translate('auto.components.settings.CliSection.c5c0f2641d', 'Kingu CLI')}
        </h2>
        <p className="text-xs text-muted-foreground">
          {translate(
            'auto.components.settings.CliSection.6930feda9e',
            'Use Kingu from your terminal to open the app, manage worktrees, and interact with Kingu terminals.'
          )}
        </p>
      </div>
          ...
          <div className="border-t border-border/60 pt-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Give agents Kingu-aware workspace, terminal, and progress workflows.'
                )}
              </p>
            </div>
            ...
            <AgentSkillSetupPanel
              ...
              description={translate(
                ...
                'Enables agents to use Kingu workspace, terminal, and progress commands.'
              )}
              ...
              isPrerequisiteAvailable={isKinguCliAvailableOnPath}
