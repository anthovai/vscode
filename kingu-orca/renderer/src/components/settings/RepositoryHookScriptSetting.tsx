          ...
          <p className="text-xs leading-5 text-muted-foreground">
            {notice.kind === 'checking'
              ? translate(
                  ...
                  'Local scripts are saved. Kingu is still checking kingu.yaml before it can recommend which script source to use.'
                )
              : translate(
                  'auto.components.settings.RepositoryHooksSection.0ce113fd7b',
                  'Local scripts are saved, but Script Source is set to kingu.yaml only.'
                )}
          </p>
        </div>
      </div>
