...
export function BrowserUseSetup({
  ...
  const browserUseInstallCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(KINGU_CLI_SKILL_INSTALL_COMMAND, activeSkillRuntime.agentRuntime)
    : KINGU_CLI_SKILL_INSTALL_COMMAND
  const browserUseUpdateCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(KINGU_CLI_SKILL_UPDATE_COMMAND, activeSkillRuntime.agentRuntime)
    : KINGU_CLI_SKILL_UPDATE_COMMAND
  ...
  const cliEnabled = isKinguCliAvailableOnPath(cliStatus)
