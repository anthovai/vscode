...
export type EnvBlockedReason = 'do_not_track' | 'kingu_disabled' | 'ci'
...
export function envVarNameForReason(reason: EnvBlockedReason): string {
  ...
  if (reason === 'kingu_disabled') {
    return 'KINGU_TELEMETRY_DISABLED'
  }
  return 'CI'
}
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Help us figure out what to build next. Kingu sends anonymous counts of which features you use and where things break.'
            )}{' '}
            <button
              type="button"
