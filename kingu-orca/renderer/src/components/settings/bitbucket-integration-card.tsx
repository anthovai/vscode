    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Configured via environment variables. Unset the KINGU_BITBUCKET_* variables to manage this credential in Kingu.'
        )}
      </p>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'Saved in Kingu on this machine. KINGU_BITBUCKET_* environment variables take precedence when set.'
        )}
      </p>
    )
  }
  return (
    <p className="text-xs text-muted-foreground">
      {translate(
        ...
        'Connect a Bitbucket Cloud account with an Atlassian API token or an access token. KINGU_BITBUCKET_* environment variables work too and take precedence.'
      )}
    </p>
  )
}
