...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'kingu-ide'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `kingu-ide` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Kingu itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Kingu will register {{value0}} so the command works from WSL terminals.',
