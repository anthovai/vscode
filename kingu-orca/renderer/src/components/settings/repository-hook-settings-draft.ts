  ...
  return [
    {
      ...
      placeholder: translate(
        ...
        '# e.g. pnpm install cp "$KINGU_ROOT_PATH/.env" "$KINGU_WORKTREE_PATH/.env"'
      )
    },
    {
      name: 'archive',
      ...
      placeholder: translate(
        ...
        '# e.g. echo "Cleaning up $KINGU_WORKSPACE_NAME"'
      )
    }
  ]
}
...
export function renderYamlScriptPreview(hooks: KinguHooks | null): string {
