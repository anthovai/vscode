...
import type { KinguHooks, RepoHookSettings } from '../../../../shared/kingu-yaml-hook-types'
...
export function RepositoryPane({
  ...
  const handleCopyTemplate = async () => {
    // Why: the missing-`kingu.yaml` state is a migration aid, so copying the shared-template
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <SearchableSetting
            ...
            description={translate(
              ...
              'Remove this project from Kingu on all configured hosts.'
            )}
