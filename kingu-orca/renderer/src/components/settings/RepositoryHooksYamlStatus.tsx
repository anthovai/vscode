    ...
    case 'update-available':
      return {
        heading: translate(
          ...
          '`kingu.yaml` could not be parsed'
        ),
        description: translate(
          'auto.components.settings.RepositoryHooksSection.aba825233f',
          'The file contains configuration keys that this version of Kingu does not recognize. You may need to update Kingu, or check the file for typos.'
        )
      }
    case 'invalid':
      return {
        ...
        description: translate(
          ...
          'The core configuration file exists in the repo root, but Kingu could not parse the supported hook definitions yet.'
        )
      }
    default:
      return {
        heading: translate(
          ...
          'No `kingu.yaml` detected'
        ),
        description: translate(
          'auto.components.settings.RepositoryHooksSection.b20c5df6ca',
          'Add an `kingu.yaml` file to enable shared setup, archive, or issue-automation defaults for this repo. Example template:'
        )
      }
  }
}
    ...
    <div className="space-y-2">
      <p className="text-[10px] tracking-[0.18em] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1 py-0.5">
          {translate('auto.components.settings.RepositoryHooksSection.39da2ae12f', 'kingu.yaml')}
        </code>{' '}
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              <p>
                {translate(
                  ...
                  'The file is present, but Kingu could not find valid `scripts` or `issueCommand` definitions.'
                )}
              </p>
