...
const AUTOMATIC_DEVICE_VALUE = '__kingu_automatic_emulator_device__'
  ...
  const defaultDeviceDescription = useMemo(() => {
    if (devices.length === 0) {
      return translate(
        ...
        'Kingu will auto-select an emulator device after devices are detected.'
      )
    }
    return translate(
    ...
    <div className="space-y-4">
      <SearchableSetting
        ...
        description={translate(
          ...
          'Configure mobile emulator support for Kingu and coding agents.'
        )}
