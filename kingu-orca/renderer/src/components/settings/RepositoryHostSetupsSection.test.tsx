...
describe('RepositoryHostSetupsSection', () => {
  it('shows a viewing-host selector when the project has multiple settings-backed hosts', () => {
    ...
    useAppStore.setState({
      ...
      projects: [makeProject({ id: 'github:anthovai/kingu-intelligence' })],
      projectHostSetups: [
        makeSetup({
          id: 'local-repo',
  ...
  it('keeps nested SSH setups distinct and derives readiness from their HUB owner', () => {
    ...
    useAppStore.setState({
      repos: [remoteRepo],
      projects: [
        makeProject({ id: 'github:anthovai/kingu-intelligence', sourceRepoIds: ['remote-repo'] })
      ],
      projectHostSetups: [
        makeSetup({
          id: 'direct-setup',
  ...
  it('removes independent setup metadata instead of opening an empty repo target', async () => {
    const deleteProjectHostSetup = vi.fn().mockResolvedValue({
      project: makeProject({ id: 'github:anthovai/kingu-intelligence' }),
      setup: makeSetup({
        id: 'gpu-setup',
        projectId: 'github:anthovai/kingu-intelligence',
        repoId: '',
  ...
  it('sets up the project on another known host from an existing folder path', async () => {
    ...
    typeIntoInput(pathInput!, '/home/alice/kingu')
  ...
  it('clones the project onto another known host from settings', async () => {
    ...
    typeIntoInput(urlInput!, 'https://github.com/anthovai/kingu-intelligence.git')
  ...
  it('shows unsupported runtime hosts without enabling setup actions', async () => {
    ...
    expect(container.textContent).toContain('Update Kingu on this host to set up projects')
