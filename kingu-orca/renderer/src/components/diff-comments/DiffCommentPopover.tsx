...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="kingu-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="kingu-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="kingu-diff-comment-popover-label">
          {title ??
