...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'Kingu CLI',
        description: 'Register or remove the kingu shell command.',
  ...
  },
  {
    ...
    description: 'Pair remote Kingu runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote Kingu Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
...
describe('Cmd+J palette middle-band ranking', () => {
  it.each([
    ...
    ['kingu cli', 'settings:general:cli'],
    ...
    const integrationSections: SettingsNavSection[] = [
      {
        id: 'linear',
        title: 'Linear',
        description: 'How Linear works in Kingu.',
        icon: Settings,
        searchEntries: [],
        group: 'capabilities'
      },
