...
/**
 * What Kingu tells the user after acting on a restart offer.
 *
...
/** A dismissal Kingu could not confirm. The offer belongs to the host, so say it may still be there. */
