...
const CLI_AGENT_COMMANDS = [
  'kingu worktree create --name auth-pr-1',
  'kingu worktree create --name auth-pr-2',
  'kingu orchestration dispatch --task pr1 --to w1',
  'kingu orchestration dispatch --task pr2 --to w2'
]
