...
export default function HiddenWorktreeRecoveryList({
  ...
  const filtered = normalizedQuery
    ...
    : hidden
  const discoveredCount = hidden.length + getVisibleNonKinguWorktrees(detected).length
              ...
              {normalizedQuery
                ...
                : discoveredCount > 0
                  ...
                  : translate(
                      ...
                      'New worktrees will appear here when Kingu detects them.'
                    )}
            </div>
          </div>
        </div>
