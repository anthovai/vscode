...
describe('getDefaultCloneParent', () => {
  it('strips a POSIX workspaces suffix', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/kingu/workspaces')).toBe('/Users/mvanhorn/kingu')
  })
  ...
  it('strips a Windows workspaces suffix', () => {
    expect(getDefaultCloneParent('C:\\Users\\mvanhorn\\kingu\\workspaces')).toBe(
      'C:\\Users\\mvanhorn\\kingu'
    )
  })
  ...
  it('strips repeated trailing separators before matching the suffix', () => {
    expect(getDefaultCloneParent('D:\\kingu\\workspaces\\\\')).toBe('D:\\kingu')
  })

  it('does not strip a similar-looking final segment', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/kingu/project-workspaces')).toBe(
      '/Users/mvanhorn/kingu/project-workspaces'
    )
  })
})
  ...
  it('fills the local clone destination from the workspace directory', () => {
    expect(
      getCloneDestinationAutoFill({
        ...
        workspaceDir: '/Users/mvanhorn/kingu/workspaces',
        cloneStepAutoFilled: false
      })
    ).toEqual({ destination: '/Users/mvanhorn/kingu' })
  })
