...
describe('delete worktree flow', () => {
  ...
  it('opens project removal confirmation for a primary workspace', () => {
    ...
    mocks.state.repos = [{ id: 'repo-1', displayName: 'kingu' }]
  ...
  it('routes primary workspace removal to its exact SSH host', () => {
    ...
    mocks.state.repos = [
      { id: 'repo-1', displayName: 'local kingu' },
      { id: 'repo-1', displayName: 'provisioned kingu', connectionId: 'runtime-ssh-one' }
    ]
