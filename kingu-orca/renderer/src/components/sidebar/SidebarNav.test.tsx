...
describe('SidebarNav', () => {
  ...
  it('updates localized labels when the language changes after mount', async () => {
    ...
    expect(queryButtonByText(container, 'Kingu Mobile')).not.toBeNull()
    ...
    expect(queryButtonByText(container, 'Kingu 手机端')).not.toBeNull()
  })
  ...
  it('shows the inline hide control only once a device is paired', async () => {
    ...
    expect(queryButtonByText(beforePairing, 'Kingu Mobile')).not.toBeNull()
  ...
  it('hides Mobile from its sidebar context menu', async () => {
    ...
    const mobileMenu = getButtonByText(container, 'Kingu Mobile').closest(
      '[data-testid="context-menu"]'
    )
