...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'kingu.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves Kingu's pseudo-localization behavior. Without it the
