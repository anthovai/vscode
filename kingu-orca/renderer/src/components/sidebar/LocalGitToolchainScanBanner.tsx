  ...
  'xcode-license': {
    ...
    body: () =>
      translate(
        ...
        'macOS blocks Git until you accept it. Run this in Terminal, then switch back to Kingu. It will check again automatically.'
      )
  },
  'developer-tools': {
    ...
    body: () =>
      translate(
        ...
        "Git needs Apple's developer tools. Run this in Terminal, then switch back to Kingu. It will check again automatically."
      )
  }
}
...
export function LocalGitToolchainScanBanner(): React.JSX.Element | null {
  ...
  React.useEffect(() => {
    ...
    // Why: the fix happens in Terminal, so returning to Kingu is the moment to check again.
