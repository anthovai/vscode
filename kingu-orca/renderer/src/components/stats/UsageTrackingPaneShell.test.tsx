    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="kingu"
          options={[
            { value: 'kingu', label: 'Kingu worktrees only' },
      ...
      selectionSummary="Kingu worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Kingu worktrees only • Last 7 days')).toBeInTheDocument()
