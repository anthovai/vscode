...
export default function MobilePage(): React.JSX.Element {
  ...
  const signedIn = useAppStore((state) => state.kinguProfileAuthStatus?.state === 'connected')
  const refreshAuthStatus = useAppStore((state) => state.fetchKinguProfileAuthStatus)
