...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Kingu Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Kingu Mobile')
  })

  it('labels the restore action explicitly when Kingu Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
