                ...
                <Tooltip key={mode.id}>
                  ...
                  <TooltipContent side="bottom" sideOffset={6}>
                    {translate(
                      ...
                      'Linear tickets linked to an Kingu workspace'
                    )}
                  </TooltipContent>
                </Tooltip>
              )
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                disabled={
                  linearMode === 'issues' || linearMode === 'in-kingu'
                    ? linearLoading
                    : linearMode === 'projects'
                ...
                className="size-8 border-border/50 bg-transparent hover:bg-muted/50 backdrop-blur-md supports-[backdrop-filter]:bg-transparent"
              >
                {(linearMode === 'issues' || linearMode === 'in-kingu') && linearLoading ? (
            ...
            <Input
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  ...
                  setTaskResumeState({
                    linearQuery: trimmed,
                    linearMode: linearMode === 'in-kingu' ? 'in-kingu' : 'issues'
                  })
                  if (linearMode !== 'in-kingu') {
              ...
              placeholder={
                linearMode === 'in-kingu'
                  ? translate(
                      ...
                      'Filter issues linked to an Kingu workspace...'
                    )
