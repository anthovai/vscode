...
export function FileExplorerRowContextMenu({
  ...
  const handleOpenInKinguBrowser = useCallback(() => {
    if (!activeWorktreeId) {
      return
    }
  ...
  return (
    ...
    >
      ...
      {!node.isDirectory && activeWorktreeId && canOpenInKinguBrowser && (
        <ContextMenuItem onSelect={handleOpenInKinguBrowser}>
          <Globe />
          {translate(
