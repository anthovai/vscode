...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/kingu-cli',
    resolvedPath: '/home/.agents/skills/kingu-cli',
    physicalIdentity: 'physical-kingu-cli',
...
const DISMISSAL_KEY = ['physical-kingu-cli', 'kingu-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/kingu-cli',
          resolvedPath: '/home/projects/work/.agents/skills/kingu-cli',
          physicalIdentity: 'physical-repo-kingu-cli'
        })
      ],
      eligibleUpdateNames: ['kingu-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-kingu-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['kingu-cli'],
      scanIssues: [],
