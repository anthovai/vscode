...
import { TitlebarCommandCenter } from './app-shell/TitlebarCommandCenter'
      ...
      <TooltipProvider delayDuration={400}>
        <ConfirmationDialogProvider>
          ...
          <LinkRoutingPreferenceDialogProvider>
            ...
            {/* The window's top row: the Agents Window title bar. Above the
                workspace shell rather than inside it, so it spans the sidebar,
                the panes and the right sidebar the way that window's does — and
                so Kingu's own tab strip keeps its row, one line further down. */}
            <TitlebarCommandCenter floatingWorkspace={floatingWorkspace} />
