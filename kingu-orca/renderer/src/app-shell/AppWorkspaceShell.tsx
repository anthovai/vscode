    ...
    >
      <div className="flex flex-row flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 min-w-0 min-h-0">
          ...
          <div className="flex flex-row flex-1 min-h-0 overflow-hidden">
            {/* Why no titlebar-height header above the sidebar: the Agents Window
                title bar (TitlebarCommandCenter) is the window's top row now and
                already carries the sidebar toggle, so a second chrome strip here
                only stacked a duplicate toggle under the first. */}
            {layout.showSidebar ? (
