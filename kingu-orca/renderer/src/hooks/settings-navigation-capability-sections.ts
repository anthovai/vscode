...
import { getKinguAccountSettingsSearchEntries } from '@/components/settings/kingu-account-settings-search'
import { KinguLogoSettingsIcon } from '@/components/settings/kingu-logo-settings-icon'
  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Coordinate multiple coding agents through Kingu.'
      ),
      icon: Network,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'How Linear works in Kingu, setup checklist, agent skill, and example prompts.'
            ),
            icon: LinearIcon,
  ...
  return [
    ...(showDesktopOnlySettings
      ? [
          {
            id: 'kingu-account',
            title: translate('auto.components.settings.kinguAccount.title', 'Kingu Account'),
            description: translate(
              'auto.components.settings.kinguAccount.description',
              'Share work instantly and reach your desktop from Kingu Mobile wherever you are.'
            ),
            icon: CircleUserRound,
            searchEntries: getKinguAccountSettingsSearchEntries(),
            group: 'setup'
          }
        ]
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core Kingu workflows.'
      ),
      icon: KinguLogoSettingsIcon,
      searchEntries: [
        {
          title: translate(
            'auto.hooks.useSettingsNavigationMetadata.ded9e9032f',
