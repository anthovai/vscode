export const KINGU_TERMINAL_COMMAND_FINISHED_EVENT = 'kingu:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(KINGU_TERMINAL_COMMAND_FINISHED_EVENT, {
