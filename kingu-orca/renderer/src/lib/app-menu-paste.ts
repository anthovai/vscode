...
export const APP_MENU_PASTE_EVENT = 'kingu-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Kingu already resolved.
  ...
  // Why: for text controls Kingu has already resolved ownership. Falling back
