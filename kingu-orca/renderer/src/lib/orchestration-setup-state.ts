export const ORCHESTRATION_SETUP_STATE_EVENT = 'kingu:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'kingu.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'kingu.orchestration.setupDismissed'
