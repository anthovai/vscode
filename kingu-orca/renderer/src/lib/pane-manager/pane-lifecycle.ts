...
export function openTerminal(
  ...
  // Activate Kingu's Unicode 11 width shim *before* any caller-driven write. CJK / emoji /
  ...
  // Deferred attachment restores Kingu's DA1 handler after the addon registers its own.
  if (inlineImages) {
