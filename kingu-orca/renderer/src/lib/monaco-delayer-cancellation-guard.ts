...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __kinguDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__kinguDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__kinguDelayerCancellationGuardInstalled = true
}
