...
describe('splitPathHeadForElision', () => {
  it('keeps the last two segments as the tail', () => {
    expect(
      splitPathHeadForElision('/Users/me/projects/kingu/proposals/create-button.html')
    ).toEqual({
      head: '/Users/me/projects/kingu',
  ...
  it('leaves short or shallow paths whole', () => {
    ...
    expect(splitPathHeadForElision('/tmp/kingu-create-button/create-button.html')).toEqual({
      head: '/tmp',
      tail: '/kingu-create-button/create-button.html',
      tailRanges: []
    })
  })

  it('extends the tail back to the first matched segment and re-bases ranges', () => {
    const path = '/Users/me/projects/kingu/new-create-button-design/proposals/create-button.html'
