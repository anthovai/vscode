...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-kingu-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'kingu-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'kingu-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting Kingu's pane drop layer handle it.
