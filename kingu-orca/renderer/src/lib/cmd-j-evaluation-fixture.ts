...
export const CMD_J_FIXTURE_PORTS: ReadonlyMap<string, { port: number; processName?: string }[]> =
  new Map([
    ['wt-main-kingu', [{ port: 3000, processName: 'node' }]],
...
export const CMD_J_FIXTURE_CASES: readonly CmdJFixtureCase[] = [
  ...
  { query: 'main 3000', expected: ['wt-main-kingu'] },
  { query: 'acme/kingu main', expected: ['wt-main-kingu'] },
  { query: 'kingu/main', expected: ['wt-main-kingu'] },
