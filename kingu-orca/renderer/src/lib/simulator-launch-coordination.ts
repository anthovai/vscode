...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'kingu:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'kingu:emulator-launch-failed'
