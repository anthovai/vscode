...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __kinguDiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __kinguDiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__kinguDiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__kinguDiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__kinguDiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__kinguDiffEditorFactoryGuardInstalled = true
}
