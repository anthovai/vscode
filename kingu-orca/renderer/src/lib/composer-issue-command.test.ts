...
const readyInput = {
  ...
  artifactUrl: 'https://github.com/anthovai/kingu-intelligence/issues/42'
}
...
describe('composer issue command', () => {
  it('renders a trusted GitHub issue command', () => {
    expect(buildTrustedComposerIssueCommand({ ...readyInput, trustDecision: 'run' })).toEqual({
      command: 'gh issue view 42 --repo https://github.com/anthovai/kingu-intelligence/issues/42'
    })
  })
