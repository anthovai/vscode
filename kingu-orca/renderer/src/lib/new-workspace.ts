...
// Why: when a repo has no `kingu.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: KinguHooks | null): string {
 ...
 * their `kingu.yaml` / `.kingu/issue-command` yet.
 */
