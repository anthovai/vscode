...
type ReferenceWidgetConstructor = {
  prototype: ReferenceWidgetInstance & {
    __kinguPeekPreviewOptionsInstalled?: true
  }
}

function applyPeekReferencesPreviewOptions(editor: PeekPreviewEditor | undefined): void {
  // Why: Monaco embedded editors inherit Kingu's full-editor options first.
...
export function installMonacoPeekReferencesPreviewOptions(
  ...
  if (prototype.__kinguPeekPreviewOptionsInstalled) {
    return
  }
  ...
  prototype.__kinguPeekPreviewOptionsInstalled = true
}
