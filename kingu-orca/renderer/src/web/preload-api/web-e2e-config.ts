...
export const webE2EConfig = createE2EConfig({
  ...
  terminalParkingDelayMs: Number(webE2EQuery?.get('kinguE2ETerminalParkingDelayMs')) || null,
  terminalRetentionLimit: Number(webE2EQuery?.get('kinguE2ETerminalRetentionLimit')) || null
})
