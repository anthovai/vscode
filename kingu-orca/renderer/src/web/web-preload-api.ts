...
import { createWebKinguProfilesApi } from './preload-api/web-kingu-profiles-api'
...
export function installWebPreloadApi(): void {
  ...
  const webWindow = window as unknown as { __KINGU_WEB_CLIENT__?: boolean }
  webWindow.__KINGU_WEB_CLIENT__ = true
