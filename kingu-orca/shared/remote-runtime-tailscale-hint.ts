...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote kingu runtime|remote kingu runtime closed the connection|timed out (?:waiting for|while connecting to) the remote kingu runtime/i
