// Per-step copy for the agents-orchestration tile in the Explore Kingu modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate Kingu workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
