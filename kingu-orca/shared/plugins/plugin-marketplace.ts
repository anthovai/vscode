...
export const PLUGIN_MARKETPLACE_FILENAME = 'kingu-marketplace.json'
export const PLUGIN_MARKETPLACE_ENTRY_LIMIT = 2_048
export const PLUGIN_MARKETPLACE_CATEGORY_LIMIT = 16

export const OFFICIAL_PLUGIN_PUBLISHER = 'anthovai'
export const OFFICIAL_PLUGIN_ID_PREFIX = 'kingu-'
export const OFFICIAL_MARKETPLACE_OWNER = 'anthovai'
export const OFFICIAL_MARKETPLACE_REPOSITORY = 'kingu-plugins'
...
export const OFFICIAL_MARKETPLACE_GIT_SOURCE: PluginMarketplaceGitSource = {
  kind: 'git',
  url: 'https://github.com/anthovai/kingu-intelligence-plugins.git',
  ref: 'main'
}
