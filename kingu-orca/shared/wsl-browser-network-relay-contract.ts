...
export const WSL_BROWSER_NETWORK_RELAY_DIR = '.kingu-wsl/browser-network'
export const WSL_BROWSER_NETWORK_RELAY_SENTINEL = 'KINGU-WSL-BROWSER-NETWORK v1 READY\n'
