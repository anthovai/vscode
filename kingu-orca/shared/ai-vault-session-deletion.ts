...
// Agents whose sessions Kingu can remove completely: everything the session
...
// why (a provider's storage layout is Kingu's problem, not the reader's):
...
// - codex: session_index.jsonl plus hardlink aliases between the Kingu-managed
