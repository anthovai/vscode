...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Kingu’s built-in prompt for this action, including the context Kingu knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Kingu workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Kingu has one available.',
