 ...
 * and the `kingu-preview://` URL it is served over are minted when the page mounts and replaced on a
...
export type BrowserWorkspace = {
  id: string
  worktreeId: string
  /** Stable display label for the outer Kingu tab ("Browser 1", "Browser 2", …).
  ...
  // Kingu tab strip still renders one workspace entry. Mirror the active page's
