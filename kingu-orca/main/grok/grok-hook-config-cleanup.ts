...
// Why not "the whole object is empty": kingu-status.json is Kingu-owned, so once no hook entries
...
export function isKinguOwnedRemnant(config: HooksConfig): boolean {
