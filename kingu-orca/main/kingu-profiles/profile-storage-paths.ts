...
const LEGACY_DATA_FILE_NAME = 'kingu-data.json'
const LEGACY_BROWSER_SESSION_META_FILE_NAME = 'browser-session-meta.json'
const PROFILE_INDEX_FILE_NAME = 'kingu-profile-index.json'
const PROFILE_DATA_FILE_NAME = 'kingu-data.json'
...
export function initKinguProfilePaths(): void {
...
export function getKinguProfileIndexPath(userDataPath = getProfileUserDataPath()): string {
  return join(userDataPath, PROFILE_INDEX_FILE_NAME)
}

export function getKinguProfilesDirectory(userDataPath = getProfileUserDataPath()): string {
  return join(userDataPath, PROFILE_DIRECTORY_NAME)
}

export function getKinguProfileDirectory(
  profileId: string,
  userDataPath = getProfileUserDataPath()
): string {
  return join(getKinguProfilesDirectory(userDataPath), profileId)
}

export function getKinguProfileDataFile(
  profileId: string,
  userDataPath = getProfileUserDataPath()
): string {
  return join(getKinguProfileDirectory(profileId, userDataPath), PROFILE_DATA_FILE_NAME)
}

export function getKinguProfileBrowserSessionMetaFile(
  profileId: string,
  userDataPath = getProfileUserDataPath()
): string {
  return join(
    getKinguProfileDirectory(profileId, userDataPath),
