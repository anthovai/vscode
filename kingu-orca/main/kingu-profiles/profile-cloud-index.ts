...
export type CreateCloudLinkedKinguProfileRecordResult = KinguProfileListState & {
...
function toLocalProfile(profile: KinguProfileSummary, now: number): KinguProfileSummary {
...
export function createCloudLinkedKinguProfileRecord(
  cloud: KinguProfileCloudSummary,
  args: { name?: string },
  userDataPath: string
): CreateCloudLinkedKinguProfileRecordResult {
...
export function linkKinguProfileToCloud(
  profileId: string,
  cloud: KinguProfileCloudSummary,
  userDataPath: string
): KinguProfileListState {
...
export function unlinkKinguProfileFromCloud(
  profileId: string,
  userDataPath: string
): KinguProfileListState {
  const index = loadOrCreateProfileIndex(userDataPath)
