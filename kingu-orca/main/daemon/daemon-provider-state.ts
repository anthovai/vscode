 ...
 * reported kingud's version for both would hide exactly that.
 */
...
// Leave history sessions marked "unclean" so a daemon crash while Kingu is closed stays recoverable.
