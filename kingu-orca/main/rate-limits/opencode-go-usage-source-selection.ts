...
export type OpenCodeGoUsageSourceInput = {
  /** Explicit Kingu override; the highest-precedence key tier. */
 ...
 * @param input.settingsApiKey - Explicit Kingu override, if the user set one.
 * @param input.cookie - The opencode.ai cookie header from Kingu settings.
