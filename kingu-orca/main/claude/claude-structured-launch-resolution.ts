...
export type ClaudeStructuredLaunchResolverDeps = {
  ...
  resolveEnv?: () =>
    ...
    | undefined
  /** The env the child inherits before auth stripping; absent inherits Kingu's own process env. */
  ...
  return async ({ identity }) => {
    ...
    return {
      ...
      options: {
        ...
        // Claude owns where a resumed conversation continues; the stored leaf is Kingu's bookkeeping.
        ...(head?.handle.provider === 'claude'
