...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'kingu-amp-home-'))
  ...
  it('installs an Kingu-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.KINGU_PANE_KEY')
  ...
  it('removes only Kingu-managed Amp plugin files', () => {
