 ...
 *
 * Probes are always secondary to Kingu automation list and mutation traffic, so
...
export class ExternalAutomationProbeScheduler {
  ...
  /** Held for the duration of Kingu list/mutation work; queued probes wait behind it. */
