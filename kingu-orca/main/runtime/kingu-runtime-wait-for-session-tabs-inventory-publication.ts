...
import { KinguRuntimeWithCollectMobileVisibleGraphChangedWorktrees } from './kingu-runtime-collect-mobile-visible-graph-changed-worktrees'

export class KinguRuntimeWithWaitForSessionTabsInventoryPublication extends KinguRuntimeWithCollectMobileVisibleGraphChangedWorktrees {
