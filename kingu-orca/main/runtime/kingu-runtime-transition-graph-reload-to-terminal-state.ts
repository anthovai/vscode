...
import { KinguRuntimeWithHasTerminalsForWorktree } from './kingu-runtime-has-terminals-for-worktree'
...
export class KinguRuntimeWithTransitionGraphReloadToTerminalState extends KinguRuntimeWithHasTerminalsForWorktree {
