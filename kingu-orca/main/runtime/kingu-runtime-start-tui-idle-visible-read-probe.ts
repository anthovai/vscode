...
import { KinguRuntimeWithCreateAgentPromptRenderGate } from './kingu-runtime-create-agent-prompt-render-gate'
import type {
...
export class KinguRuntimeWithStartTuiIdleVisibleReadProbe extends KinguRuntimeWithCreateAgentPromptRenderGate {
