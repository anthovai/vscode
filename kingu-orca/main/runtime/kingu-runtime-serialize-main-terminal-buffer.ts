...
import { KinguRuntimeWithAttachRemoteTerminalSourceRangeConsumer } from './kingu-runtime-attach-remote-terminal-source-range-consumer'
...
export class KinguRuntimeWithSerializeMainTerminalBuffer extends KinguRuntimeWithAttachRemoteTerminalSourceRangeConsumer {
  ...
  // Why: daemon-backed PTYs that the runtime adopted after an Kingu relaunch
