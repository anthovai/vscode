...
const { mergeGitLabMRMock, muxRequestMock, parseKinguYaml, prepareLocalWorktreeRootForRepoMock } =
  mocks
...
function resetRuntimeTestMocks(): void {
  ...
  vi.mocked(parseKinguYaml).mockReset()
  ...
  vi.mocked(parseKinguYaml).mockReturnValue(null)
