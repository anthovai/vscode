...
import { KinguRuntimeWithPtyForegroundProcessReads } from './kingu-runtime-pty-foreground-process-reads'
import type {
...
export class KinguRuntimeWithAutomationOperations extends KinguRuntimeWithPtyForegroundProcessReads {
