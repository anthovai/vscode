...
import * as setup from './kingu-runtime-test-mocks/setup.spec'
import * as importedValues from './kingu-runtime-test-mocks/imported-values.spec'
...
export const KinguRuntimeService = importedValues.exportedKinguRuntimeService
...
export const parseKinguYaml = importedValues.exportedParseKinguYaml
...
} from './kingu-runtime-test-mocks/setup.spec'
...
export { electronMocks } from './kingu-runtime-test-mocks/setup.spec'
export {
...
export type KinguRuntimeService = InstanceType<typeof importedValues.exportedKinguRuntimeService>
...
export type { RuntimeTerminalAgentStatusEvent } from './kingu-runtime'
