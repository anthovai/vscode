...
import { KinguRuntimeWithBindPtyIncarnationHandle } from './kingu-runtime-bind-pty-incarnation-handle'
...
import { TUI_IDLE_QUIESCENCE_MS } from './kingu-runtime-postlude'

export class KinguRuntimeWithResolveExitWaiters extends KinguRuntimeWithBindPtyIncarnationHandle {
