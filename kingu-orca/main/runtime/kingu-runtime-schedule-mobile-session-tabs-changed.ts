...
import { KinguRuntimeWithStoredMobileSnapshotHasStalePreservedTab } from './kingu-runtime-stored-mobile-snapshot-has-stale-preserved-tab'
import type {
  BrowserTabInfo,
...
export class KinguRuntimeWithScheduleMobileSessionTabsChanged extends KinguRuntimeWithStoredMobileSnapshotHasStalePreservedTab {
