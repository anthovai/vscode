...
import { KinguRuntimeWithMobileTookFloor } from './kingu-runtime-mobile-took-floor'
import {
  MOBILE_AUTO_RESTORE_FIT_MAX_MS,
  MOBILE_AUTO_RESTORE_FIT_MIN_MS
} from './kingu-runtime-postlude'

export class KinguRuntimeWithReclaimTerminalForDesktop extends KinguRuntimeWithMobileTookFloor {
