...
import { acknowledgeAgentPromptSubmit } from '../kingu-runtime-test-mocks.spec'
import {
  TEST_WORKTREE_PATH,
    ...
    runtime.onPtyData(
      ...
      [
        ...
        [
          ...
          'Run /review on my current changes gpt-5.5 high ~/kingu/workspaces/kingu/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/kingu/workspaces/kingu/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/kingu/workspaces/kingu/cli-debug',
          'Run /review on my current changes gpt-5.5 high ~/kingu/workspaces/kingu/cli-debug\n'
        ].join('')
  ...
  it.each([
    ...
    try {
      ...
      expect(writes).toEqual([
        typesLead ? `${KINGU_DISPATCH_PROMPT_LEAD_LINE} ${paste}` : paste,
        '\r'
      ])
    } finally {
      vi.useRealTimers()
