...
import { KinguRuntimeService, join, listWorktrees, tmpdir } from '../kingu-runtime-test-mocks.spec'
import type { WorktreeLineage, WorktreeMeta } from '../kingu-runtime-test-mocks.spec'
import {
  TEST_REPO_ID,
  TEST_WORKTREE_ID,
  makeWorktreeInfo,
...
describe('KinguRuntimeService', () => {
  it('strips Kingu provenance fields from runtime metadata updates', async () => {
    ...
    await runtime.updateManagedWorktreeMeta(`id:${TEST_WORKTREE_ID}`, {
      ...
      kinguCreationWorkspaceLayout: { path: '/tmp', nestWorkspaces: false }
    })
