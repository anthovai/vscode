...
import { KinguRuntimeWithRestoreStructuredAgentSessionTabsOnce } from './kingu-runtime-restore-structured-agent-session-tabs-once'
import { DEFAULT_WORKTREE_LIST_LIMIT } from './kingu-runtime-postlude'
...
export class KinguRuntimeWithListManagedWorktrees extends KinguRuntimeWithRestoreStructuredAgentSessionTabsOnce {
