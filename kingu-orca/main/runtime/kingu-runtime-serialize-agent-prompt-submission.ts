...
import { KinguRuntimeWithControllerKnowsPtyIsLive } from './kingu-runtime-controller-knows-pty-is-live'
...
export class KinguRuntimeWithSerializeAgentPromptSubmission extends KinguRuntimeWithControllerKnowsPtyIsLive {
