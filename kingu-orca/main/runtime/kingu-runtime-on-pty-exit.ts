...
import { KinguRuntimeWithOnClientDisconnected } from './kingu-runtime-on-client-disconnected'
...
export class KinguRuntimeWithOnPtyExit extends KinguRuntimeWithOnClientDisconnected {
  onPtyExit(
    ptyId: string,
    exitCode: number,
