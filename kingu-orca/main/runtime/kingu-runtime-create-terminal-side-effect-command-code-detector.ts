...
import { KinguRuntimeWithApplyTrackedPtyTitle } from './kingu-runtime-apply-tracked-pty-title'
import type {
...
export class KinguRuntimeWithCreateTerminalSideEffectCommandCodeDetector extends KinguRuntimeWithApplyTrackedPtyTitle {
