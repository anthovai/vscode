...
import { KinguRuntimeWithResolveWorktreeRemovalTarget } from './kingu-runtime-resolve-worktree-removal-target'
...
export class KinguRuntimeWithGetAgentSessionExecutionNamespace extends KinguRuntimeWithResolveWorktreeRemovalTarget {
