...
import { KinguRuntimeWithHasRecentTerminalOutputPath } from './kingu-runtime-has-recent-terminal-output-path'
import type { RuntimeCommandSurfaceHost } from './kingu-runtime-core'

export class KinguRuntimeWithOnClientDisconnected extends KinguRuntimeWithHasRecentTerminalOutputPath {
