...
import { KinguRuntimeWithCloseMobileSessionTab } from './kingu-runtime-close-mobile-session-tab'
import type {
...
export class KinguRuntimeWithCloseStructuredAgentSessionTab extends KinguRuntimeWithCloseMobileSessionTab {
