...
import { KinguRuntimeWithStartTuiIdleVisibleReadProbe } from './kingu-runtime-start-tui-idle-visible-read-probe'
...
export class KinguRuntimeWithStructuredAgentSessionLaunchTui extends KinguRuntimeWithStartTuiIdleVisibleReadProbe {
