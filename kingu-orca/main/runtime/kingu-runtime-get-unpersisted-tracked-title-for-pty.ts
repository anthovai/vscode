...
import { KinguRuntimeWithEmitDaemonPtyTransientFact } from './kingu-runtime-emit-daemon-pty-transient-fact'
...
export class KinguRuntimeWithGetUnpersistedTrackedTitleForPty extends KinguRuntimeWithEmitDaemonPtyTransientFact {
