...
import { KinguRuntimeWithTransitionGraphReloadToTerminalState } from './kingu-runtime-transition-graph-reload-to-terminal-state'
...
import type { ResolvedTerminalWorkspaceLaunchTarget } from './kingu-runtime-core'
import { AGENT_HOOK_RUNTIME_ENV_KEYS } from './kingu-runtime-core'
...
export class KinguRuntimeWithResolveBrowserNetworkExecutionHostForWorktree extends KinguRuntimeWithTransitionGraphReloadToTerminalState {
  ...
  protected buildTerminalWorkspaceEnv(
    ...
    return {
      ...env,
      KINGU_WORKSPACE_ID: scope.id,
      KINGU_PROJECT_GROUP_ID: scope.folderWorkspace.projectGroupId,
      KINGU_WORKSPACE_ROOT: scope.folderWorkspace.folderPath
    }
  }
