...
import { KinguRuntimeWithRefreshFloatingWorkspacePtyLiveness } from './kingu-runtime-refresh-floating-workspace-pty-liveness'
...
export class KinguRuntimeWithWriteOrchestrationPointerPty extends KinguRuntimeWithRefreshFloatingWorkspacePtyLiveness {
