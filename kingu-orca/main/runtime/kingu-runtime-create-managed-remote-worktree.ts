...
import { KinguRuntimeWithCreateManagedWorktree } from './kingu-runtime-create-managed-worktree'
...
export class KinguRuntimeWithCreateManagedRemoteWorktree extends KinguRuntimeWithCreateManagedWorktree {
