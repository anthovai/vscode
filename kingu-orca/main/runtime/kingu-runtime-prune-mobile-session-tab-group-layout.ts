...
import { KinguRuntimeWithScheduleMobileSessionTabsChanged } from './kingu-runtime-schedule-mobile-session-tabs-changed'
...
export class KinguRuntimeWithPruneMobileSessionTabGroupLayout extends KinguRuntimeWithScheduleMobileSessionTabsChanged {
