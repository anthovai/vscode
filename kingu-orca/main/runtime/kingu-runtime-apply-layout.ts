...
import { KinguRuntimeWithPickMostRecentActor } from './kingu-runtime-pick-most-recent-actor'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './kingu-runtime-core'

export class KinguRuntimeWithApplyLayout extends KinguRuntimeWithPickMostRecentActor {
