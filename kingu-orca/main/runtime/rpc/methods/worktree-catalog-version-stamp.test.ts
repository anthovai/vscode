...
function stubRuntime(stub: Record<string, unknown>): KinguRuntimeService {
  ...
  return stub as unknown as KinguRuntimeService
}

async function dispatch(runtime: KinguRuntimeService, method: string, params: unknown) {
