...
import { RuntimeGitCommands, type ResolvedRuntimeGitWorktree } from '../../kingu-runtime-git'
...
/** Stands in for kingu-runtime-git.ts, which enforces the budget it is handed as its last argument. */
function stubRuntime(runtimeMethod: string): KinguRuntimeService {
  return {
...
function budgetArgument(runtime: KinguRuntimeService, runtimeMethod: string): unknown {
