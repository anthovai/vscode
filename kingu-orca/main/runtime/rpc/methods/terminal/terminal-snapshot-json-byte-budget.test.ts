 ...
 */
function denseRuntime(): Pick<KinguRuntimeService, 'serializeTerminalBuffer'> {
  return {
 ...
 * 655,360-byte cap.
 */
function exactlyAtRoundOnesBudgetRuntime(): Pick<KinguRuntimeService, 'serializeTerminalBuffer'> {
 ...
 */
function alwaysOversizeRuntime(): Pick<KinguRuntimeService, 'serializeTerminalBuffer'> {
  return {
...
describe('the publication fields the budget has to assume', () => {
  ...
  function fixedScreenRuntime(data: string): Pick<KinguRuntimeService, 'serializeTerminalBuffer'> {
    return {
      serializeTerminalBuffer: vi.fn(async () => ({
        data,
        cols: COLUMNS,
