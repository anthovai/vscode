 ...
 *  KINGU_E2E_FORCE_REMOTE_TERMINAL_INITIAL_SNAPSHOT_TRUNCATED. */
function isTerminalSnapshotForcedUnavailable(): boolean {
  return process.env.KINGU_E2E_FORCE_REMOTE_TERMINAL_SNAPSHOT_UNAVAILABLE === '1'
}
...
type TerminalBufferSource = Pick<KinguRuntimeService, 'serializeTerminalBuffer'>
...
type MobileDisplayMode = ReturnType<KinguRuntimeService['getMobileDisplayMode']>
