 ...
 * is not "whatever ships in this build": it is the `kingu` CLI over the runtime socket and the
...
async function agentLaunchTarget(
  ...
  runtime: Pick<KinguRuntimeService, 'showTerminalWorkspaceLaunchScope'>
...
async function validateReusedTerminal(
  ...
  runtime: Pick<KinguRuntimeService, 'showTerminal' | 'isTerminalRunningAgent'>
): Promise<void> {
...
function activeAgentLaunchesFor(runtime: KinguRuntimeService): Map<string, ActiveAgentLaunch> {
