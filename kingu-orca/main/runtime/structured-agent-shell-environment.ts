...
/** Overlays shell variables on Kingu's env; win32 names are case-insensitive, so drop the base spelling. */
 ...
 * Inheriting everything is the login-shell snapshot as-is; otherwise Kingu's own env plus
