...
import { KinguRuntimeWithResolveKnownWorkspaceFileTarget } from './kingu-runtime-resolve-known-workspace-file-target'
...
export class KinguRuntimeWithInvalidateAllHandlesForPty extends KinguRuntimeWithResolveKnownWorkspaceFileTarget {
