...
import { KinguRuntimeWithHasExactPersistedTerminalSurfaceIdentity } from './kingu-runtime-has-exact-persisted-terminal-surface-identity'
import type {
...
export class KinguRuntimeWithGetRuntimeId extends KinguRuntimeWithHasExactPersistedTerminalSurfaceIdentity {
  getRuntimeId(): string {
