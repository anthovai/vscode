...
import { KinguRuntimeWithStructuredAgentSessionLaunchTui } from './kingu-runtime-structured-agent-session-launch-tui'
...
export class KinguRuntimeWithStructuredAgentSessionReproveTuiOwner extends KinguRuntimeWithStructuredAgentSessionLaunchTui {
