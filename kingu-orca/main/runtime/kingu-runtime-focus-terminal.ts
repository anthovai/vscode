...
import { KinguRuntimeWithWaitForLeafPtyId } from './kingu-runtime-wait-for-leaf-pty-id'
...
export class KinguRuntimeWithFocusTerminal extends KinguRuntimeWithWaitForLeafPtyId {
  async focusTerminal(
    handle: string,
