...
import { KinguRuntimeWithFocusTerminal } from './kingu-runtime-focus-terminal'
import { EXPLICIT_TERMINAL_CLOSE_STOP_TIMEOUT_MS } from './kingu-runtime-core'
...
export class KinguRuntimeWithStopExplicitlyClosedTabPtys extends KinguRuntimeWithFocusTerminal {
