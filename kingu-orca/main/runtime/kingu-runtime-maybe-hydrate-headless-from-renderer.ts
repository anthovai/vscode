...
import { KinguRuntimeWithSerializeMainTerminalBuffer } from './kingu-runtime-serialize-main-terminal-buffer'
...
export class KinguRuntimeWithMaybeHydrateHeadlessFromRenderer extends KinguRuntimeWithSerializeMainTerminalBuffer {
