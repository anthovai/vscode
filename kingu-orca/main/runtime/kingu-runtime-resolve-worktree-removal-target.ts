...
import { KinguRuntimeWithRemoveManagedWorktree } from './kingu-runtime-remove-managed-worktree'
...
export class KinguRuntimeWithResolveWorktreeRemovalTarget extends KinguRuntimeWithRemoveManagedWorktree {
