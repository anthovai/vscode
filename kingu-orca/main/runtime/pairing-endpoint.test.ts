...
describe('resolveAdvertisedPairingEndpoint', () => {
  ...
  it.each([
    ...
    ['http://proxy.example.test/kingu', 'ws://proxy.example.test/kingu'],
    ['https://proxy.example.test/kingu', 'wss://proxy.example.test/kingu'],
    [
      'wss://proxy.example.test:8443/kingu?route=runtime',
      'wss://proxy.example.test:8443/kingu?route=runtime'
    ]
...
describe('resolveAdvertisedPairingHostname', () => {
  ...
  it.each([
    ...
    ['desktop', 'desktop'],
    ['wss://proxy.example.test:8443/kingu', 'proxy.example.test']
