...
import { KinguRuntimeWithSubscribeToTerminalResize } from './kingu-runtime-subscribe-to-terminal-resize'
import type {
...
export class KinguRuntimeWithAdoptTerminalOrphansFromInventory extends KinguRuntimeWithSubscribeToTerminalResize {
  ...
  async resolveActiveTerminal(
    ...
    // structured worker is covered by the `KINGU_TERMINAL_HANDLE` its child is spawned with. That
    ...
    // pane the guess resolves. Such a child now carries `KINGU_STRUCTURED_SESSION` and the CLI
