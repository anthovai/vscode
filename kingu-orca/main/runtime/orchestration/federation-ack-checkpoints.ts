...
const federationAckStates = new WeakMap<KinguRuntimeService, FederationAckRuntimeState>()

export function clearFederationAckCheckpoints(runtime: KinguRuntimeService): void {
