...
import { KinguRuntimeWithResolveTerminalPane } from './kingu-runtime-resolve-terminal-pane'
import { PROVEN_ABSENT_LEAF_PTY_TTL_MS } from './kingu-runtime-core'
...
export class KinguRuntimeWithControllerKnowsPtyIsLive extends KinguRuntimeWithResolveTerminalPane {
