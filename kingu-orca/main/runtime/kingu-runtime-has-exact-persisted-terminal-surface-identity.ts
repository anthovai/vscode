...
import { KinguRuntimeWithAutomationOperations } from './kingu-runtime-automation-operations'
import {
...
export class KinguRuntimeWithHasExactPersistedTerminalSurfaceIdentity extends KinguRuntimeWithAutomationOperations {
