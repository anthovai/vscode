...
import { KinguRuntimeWithMoveHeadlessMobileSessionTab } from './kingu-runtime-move-headless-mobile-session-tab'
import type {
...
export class KinguRuntimeWithPersistHeadlessTerminalTitle extends KinguRuntimeWithMoveHeadlessMobileSessionTab {
