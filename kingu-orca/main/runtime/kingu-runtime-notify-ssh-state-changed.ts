...
import { KinguRuntimeWithGetStatus } from './kingu-runtime-get-status'
...
export class KinguRuntimeWithNotifySshStateChanged extends KinguRuntimeWithGetStatus {
  ...
  protected bumpSshRelayRecoveryGeneration(targetId: string): number {
    ...
    while (
      ...
      KinguRuntimeWithNotifySshStateChanged.MAX_SSH_RELAY_RECOVERY_GENERATIONS
    ) {
