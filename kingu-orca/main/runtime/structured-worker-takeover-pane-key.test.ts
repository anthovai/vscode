...
const { KinguRuntimeWithGetPtyRecordForPaneKey } =
  await import('./kingu-runtime-get-pty-record-for-pane-key')
const {
...
function runtime() {
  return Object.assign(Object.create(KinguRuntimeWithGetPtyRecordForPaneKey.prototype), {
