...
import { KinguRuntimeWithGetTerminalInteractiveWait } from './kingu-runtime-get-terminal-interactive-wait'
import type {
  RuntimeTerminalRead,
...
export class KinguRuntimeWithResolveTerminalPane extends KinguRuntimeWithGetTerminalInteractiveWait {
