...
export class KinguRuntimeWithRuntimeId {
  ...
  /** The agent Kingu believes owns this pane, for tui-idle evidence ranking. Launch
   *  authority first; the live foreground agent covers panes Kingu did not launch. */
