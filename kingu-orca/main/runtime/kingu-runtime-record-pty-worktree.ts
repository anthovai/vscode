...
import { KinguRuntimeWithRefreshRepoWorktreeScan } from './kingu-runtime-refresh-repo-worktree-scan'
...
export class KinguRuntimeWithRecordPtyWorktree extends KinguRuntimeWithRefreshRepoWorktreeScan {
