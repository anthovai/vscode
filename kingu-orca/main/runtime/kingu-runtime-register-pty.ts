...
import { KinguRuntimeWithInvalidateAllHandlesForPty } from './kingu-runtime-invalidate-all-handles-for-pty'
...
export class KinguRuntimeWithRegisterPty extends KinguRuntimeWithInvalidateAllHandlesForPty {
  registerPty(
    ptyId: string,
    worktreeId: string,
