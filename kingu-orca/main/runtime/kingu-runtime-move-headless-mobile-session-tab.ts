...
import { KinguRuntimeWithPersistHeadlessSessionTabProps } from './kingu-runtime-persist-headless-session-tab-props'
import type {
...
export class KinguRuntimeWithMoveHeadlessMobileSessionTab extends KinguRuntimeWithPersistHeadlessSessionTabProps {
