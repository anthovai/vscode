...
import { KinguRuntimeWithStructuredAgentSessionRecoverTuiOwner } from './kingu-runtime-structured-agent-session-recover-tui-owner'
import { DEFAULT_WORKTREE_PS_LIMIT } from './kingu-runtime-postlude'
...
export class KinguRuntimeWithGetWorktreePs extends KinguRuntimeWithStructuredAgentSessionRecoverTuiOwner {
  async getWorktreePs(
