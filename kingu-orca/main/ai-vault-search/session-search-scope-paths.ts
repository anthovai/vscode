...
import { buildKnownKinguWorkspaceLayouts } from '../../shared/worktree/ownership'
...
/**
 * The directories Kingu creates this repo's worktrees in, past and present, where
...
export function managedWorktreeDirectories(
  ...
  for (const layout of buildKnownKinguWorkspaceLayouts(settings, repo)) {
