...
export const RELAY_REMOTE_DIR = '.kingu-remote'
...
export function isGitResponseStreamMarker(value: unknown): value is GitResponseStreamMarker {
  if (typeof value !== 'object' || value === null || !('__kinguGitResponseStream' in value)) {
    return false
  }
  const marker = (value as { __kinguGitResponseStream?: unknown }).__kinguGitResponseStream
