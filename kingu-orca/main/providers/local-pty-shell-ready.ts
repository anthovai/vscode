 ...
 * that point each shell at its Kingu wrapper (which emits the OSC 777 marker the scanner detects).
 */
...
/** Args that point bash at Kingu's rcfile, or null when it is not usable. */
