/**
 * Content of the bash rcfile Kingu launches interactive bash with.
 *
...
export function getBashShellReadyRcfileContent(): string {
  return `# Kingu bash shell-ready wrapper
...
# PATH edits, hooks, and prompt init in Kingu startup-command shells.
