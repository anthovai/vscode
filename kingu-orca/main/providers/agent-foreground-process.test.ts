  ...
  it('keeps the Windows omp ancestor when context selects one of multiple pi descendants', async () => {
    ...
    mockWindowsRows([
      ...
      },
      {
        ...
        ppid: 101,
        name: 'pi.exe',
        commandLine: 'pi.exe --cwd C:\\repo\\kingu'
      },
      {
        pid: 103,
        ppid: 100,
    ...
    await expect(
      resolveAgentForegroundProcess(100, 'pi.exe', { contextPaths: ['C:\\repo\\kingu'] })
    ).resolves.toBe('omp')
  })
  ...
  it('recognizes a Windows shell-rooted agent when only one candidate matches the worktree path', async () => {
    ...
    mockWindowsRows([
      ...
      },
      {
        ...
        name: 'node.exe',
        commandLine:
          'node C:\\Users\\dev\\AppData\\Roaming\\npm\\node_modules\\@openai\\codex\\bin\\codex.js --cwd C:\\repo\\kingu'
      },
      {
        pid: 102,
        ppid: 100,
  ...
  it('recognizes the deepest Windows shell-rooted agent when candidates share one lineage', async () => {
    ...
    mockWindowsRows([
      ...
      },
      {
        ...
        ppid: 100,
        name: 'codex.exe',
        commandLine: 'codex --cwd C:\\repo\\kingu'
      },
      {
        pid: 102,
        ppid: 101,
        name: 'gemini.exe',
        commandLine: 'gemini --cwd C:\\repo\\kingu'
      }
    ])
