...
describe('Kingu automation traffic priority', () => {
  it('parks queued probes while Kingu automation work holds the installed lease', async () => {
    // Kingu CRUD and dispatch arrive through the runtime methods, which take the
