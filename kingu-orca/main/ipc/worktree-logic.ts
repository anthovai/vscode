...
import type { GlobalSettings, KinguWorkspaceLayout } from '../../shared/global-settings-types'
 ...
 * Windows workspace layout inside ~/kingu/workspaces on the WSL filesystem
 * (e.g. \\wsl.localhost\Ubuntu\home\user\kingu\workspaces\repo\feature).
 */
...
function workspaceRootForMirrorHome(
  ...
  return wslHome
    ? win32.join(wslHome, 'kingu', 'workspaces')
