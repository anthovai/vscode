...
export type BuildPtyHostEnvOptions = {
   ...
   *  and strip only an inherited Kingu-owned override so nested Kingu panes do not
  ...
  /** Headless paired runtimes hand browser launches to the client-hosted Kingu browser. */
