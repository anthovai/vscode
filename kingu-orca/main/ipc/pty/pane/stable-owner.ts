...
export function resolveStablePaneOwner(
  ...
  let resolved: ReturnType<KinguRuntimeService['resolveTerminalPane']> | null = null
  let resolvedHandleCandidate: ReturnType<KinguRuntimeService['resolveTerminalPane']> | null = null
