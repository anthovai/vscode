...
async function previewBundleInstall(runtime: KinguRuntimeService, input: BundlePreviewInput) {
...
export function registerSkillInstallManagementIpcHandlers(runtime: KinguRuntimeService): void {
