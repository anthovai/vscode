...
// Needs an interpreter with ipykernel, e.g. KINGU_TEST_IPYKERNEL_PYTHON=/path/to/.venv/bin/python.
const python = process.env.KINGU_TEST_IPYKERNEL_PYTHON
...
const bare = process.env.KINGU_TEST_PYTHON_WITHOUT_IPYKERNEL
