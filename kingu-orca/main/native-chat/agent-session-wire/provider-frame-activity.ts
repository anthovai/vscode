 ...
 * turn-wide frame is `system/status`, whose payload is a bare token — every sentence Kingu ever
 * put on this line for it was Kingu's own wording for `requesting`, which is true for nearly the
