...
const pidFile = process.env.KINGU_DEV_WRAPPER_TEST_PID_FILE
const envFile = process.env.KINGU_DEV_WRAPPER_TEST_ENV_FILE
...
if (!pidFile) {
  throw new Error('KINGU_DEV_WRAPPER_TEST_PID_FILE is required')
}
    ...
    JSON.stringify(
      {
        ...
        label: process.env.KINGU_DEV_INSTANCE_LABEL ?? null,
        branch: process.env.KINGU_DEV_BRANCH ?? null,
        worktreeName: process.env.KINGU_DEV_WORKTREE_NAME ?? null,
        repoRoot: process.env.KINGU_DEV_REPO_ROOT ?? null,
        badgeLabel: process.env.KINGU_DEV_DOCK_BADGE_LABEL ?? null,
        dockTitle: process.env.KINGU_DEV_DOCK_TITLE ?? null,
        stableName: process.env.KINGU_DEV_STABLE_NAME ?? null,
