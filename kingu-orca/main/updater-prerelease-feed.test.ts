  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/anthovai/kingu-intelligence/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/anthovai/kingu-intelligence/releases/download/v1.4.1/Kingu-1.4.1-arm64-mac.zip'
      ])
