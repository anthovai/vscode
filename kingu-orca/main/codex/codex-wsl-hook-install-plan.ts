...
const WSL_PATH_MISSING_OUTPUT = '__KINGU_WSL_PATH_MISSING__'
...
export function createCodexWslRuntimeHookInstallPlan(
  ...
  return {
    ...
    scriptPath: pathWin32.join(runtimeHomePath, '.kingu', 'agent-hooks', 'codex-hook.sh'),
    commandScriptPath: pathPosix.join(linuxRuntimeHome, '.kingu', 'agent-hooks', 'codex-hook.sh'),
