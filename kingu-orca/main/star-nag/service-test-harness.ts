...
export function resetStarNagMocks(mocks: StarNagMocks): void {
  ...
  mocks.checkKinguStarredMock.mockReset()
  mocks.checkKinguStarredMock.mockResolvedValue(false)
  mocks.starKinguMock.mockReset()
  mocks.starKinguMock.mockResolvedValue(true)
