...
export type AppApi = {
  ...
  /** Restarts Kingu through the normal quit pipeline so daemon-backed terminal
  ...
  /** Emits a startup benchmark marker when KINGU_STARTUP_DIAGNOSTICS is enabled. */
  ...
  /** Resolves Kingu's app-owned directory for auto-created Floating Workspace
   *  markdown notes. */
