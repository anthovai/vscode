...
export const ORCHESTRATION_COMPATIBILITY_HOST_KIND_ENV =
  'KINGU_ORCHESTRATION_COMPATIBILITY_HOST_KIND'
export const ORCHESTRATION_COMPATIBILITY_HOST_ID_ENV = 'KINGU_ORCHESTRATION_COMPATIBILITY_HOST_ID'
export const ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION_ENV =
  'KINGU_ORCHESTRATION_COMPATIBILITY_HOST_INCARNATION'
export const ORCHESTRATION_COMPATIBILITY_ATTACHMENT_ENV =
  'KINGU_ORCHESTRATION_COMPATIBILITY_ATTACHMENT'
...
export function readOrchestrationCompatibilityEvidence(
  ...
  const terminalHandle = boundedValue(env.KINGU_TERMINAL_HANDLE)
  const paneKey = boundedValue(env.KINGU_PANE_KEY)
  const launchToken = boundedValue(env.KINGU_AGENT_LAUNCH_TOKEN)
