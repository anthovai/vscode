 ...
 * workers and those workers may not dispatch further — the behaviour Kingu
...
export const NESTED_WORKER_DEPTH_EXCEEDED_NEXT_STEPS: readonly string[] = [
  ...
  'To allow deeper nesting, open Settings → Orchestration in the Kingu desktop app and raise "Nested worker depth".'
]
