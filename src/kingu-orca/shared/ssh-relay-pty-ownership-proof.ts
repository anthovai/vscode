 ...
 *  (`docs/reference/ssh-execution-boundary.md`): a second machine running the same Kingu build
...
export type RelayPtyOwnershipEvidence = {
   ...
   *  from `agentSessionOwners`: that one asks whether Kingu REGISTERED an agent session here, this
