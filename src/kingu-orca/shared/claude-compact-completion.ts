// Claude's compact lifecycle, from Kingu's side.
//
...
// path. So PreCompact proves nothing and Kingu deliberately does not register it: mapping it to
...
// Stop, so Kingu must not touch the state.
