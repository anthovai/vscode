...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__kingu_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__kinguBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-kingu-browser-annotation-overlay';
  const markerSize = 24;
