...
// a closed set (the native literal plus the labels Kingu synthesizes from Cursor hooks),
...
// Kingu's hook-synthesized spinner state, but only once a Cursor-owned title already
