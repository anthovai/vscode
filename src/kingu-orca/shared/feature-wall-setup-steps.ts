...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Kingu's browser",
    subtitle: "Use Kingu's browser",
    description:
      'Browse your web app without leaving Kingu. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Kingu CLI',
    subtitle: 'Enable Kingu CLI',
    description:
      'Register the Kingu shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Kingu so you can start agent work without hunting for folders.'
  }
] as const
