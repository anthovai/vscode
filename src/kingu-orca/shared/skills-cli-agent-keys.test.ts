...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Kingu can detect', () => {
  ...
  it("follows Kingu's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Kingu detects trae via `traecli`, which tui-agent-config calls an alias
