 ...
 * started — Kingu's launcher, a shell prompt, or a resumed session — and regardless of host.
 *
 ...
 * a user started by hand inside an Kingu WSL terminal has no launch record, no readable foreground
