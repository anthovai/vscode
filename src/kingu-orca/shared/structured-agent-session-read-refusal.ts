 ...
 * is never a transcript Kingu could not read — it is a session this host has not attached YET (the
 ...
 *
 * The genuinely latched lease — "Kingu cannot prove the previous owner exited" — reaches the client
