...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and Kingu-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'Kingu generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'Kingu generated', title: '⠋ albacore' },
        true
      )
    ).toBe('Kingu generated')
  })
