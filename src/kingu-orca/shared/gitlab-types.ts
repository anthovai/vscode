...
// Why: only the four Todo target types Kingu renders meaningfully; others (e.g. DesignManagement::Design) fall back to a generic "open URL".
...
export type GitLabWorkItemDetails = {
  /** repoId is stamped by the renderer's caller — the main process doesn't know Kingu's Repo.id. */
