...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Kingu splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · Kingu CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive Kingu when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Kingu, then split panes to keep servers, tests, logs, and agents running side by side.',
