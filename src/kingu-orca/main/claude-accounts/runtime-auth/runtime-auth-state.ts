...
export class ClaudeRuntimeAuthState {
  ...
  // Why: creds Kingu last wrote to the shared file; a mismatch on managed→default transition means an external login overwrote it, so adopt it as the new default.
