// Why a sidecar next to kingu-data.json: scan snapshots rewrite wholesale and can reach hundreds
// of KB; folding them into kingu-data.json would rewrite the whole state file per scan (the
