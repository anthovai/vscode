...
export function findKinguProfileProjectsByPath(
  ...
  const projects: FindKinguProfileProjectsByPathResult['projects'] = []

  for (const profile of getKinguProfileListState(userDataPath).profiles) {
