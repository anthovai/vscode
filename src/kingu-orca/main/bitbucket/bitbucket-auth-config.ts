...
export function getEnvAuthConfig(): BitbucketAuthConfig {
  return {
    baseUrl: envValue('KINGU_BITBUCKET_API_BASE_URL') ?? DEFAULT_API_BASE_URL,
    accessToken: envValue('KINGU_BITBUCKET_ACCESS_TOKEN'),
    email: envValue('KINGU_BITBUCKET_EMAIL'),
    apiToken: envValue('KINGU_BITBUCKET_API_TOKEN')
  }
}
