...
export async function initializeMainProcessPlugins(runtime: KinguRuntimeService): Promise<void> {
  ...
  // Why: headless `kingu serve` clients reach plugins through the runtime RPC
