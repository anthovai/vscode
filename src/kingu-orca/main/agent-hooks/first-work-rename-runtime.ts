...
export function firstWorkRenameDeps(
  ...
  return {
    ...
    canRenameKinguCreatedBranch: (worktreeId) => {
      const meta = store.getWorktreeMeta(worktreeId)
      // Why: a user branch could coincidentally match a creature name; only Kingu-stamped worktrees are safe to auto-rename.
      return !!meta?.kinguCreationSource && meta.preserveBranchOnDelete !== true
    },
