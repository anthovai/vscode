...
export const RELAY_NATIVE_CACHE_LINKED = '__KINGU_NATIVE_CACHE__LINKED'
export const RELAY_NATIVE_CACHE_SEEDED = '__KINGU_NATIVE_CACHE__SEEDED'
export const RELAY_NATIVE_CACHE_MISS = '__KINGU_NATIVE_CACHE__MISS'
export const RELAY_NATIVE_CACHE_PROMOTED = '__KINGU_NATIVE_CACHE__PROMOTED'
export const RELAY_NATIVE_CACHE_NOT_PROMOTED = '__KINGU_NATIVE_CACHE__NOT_PROMOTED'
export const RELAY_NATIVE_CACHE_LIST_OK = '__KINGU_NATIVE_CACHE__LIST_OK'
export const RELAY_NATIVE_CACHE_REFS_OK = '__KINGU_NATIVE_CACHE__REFS_OK'
export const RELAY_NATIVE_CACHE_REFS_ERR = '__KINGU_NATIVE_CACHE__REFS_ERR'
...
export function ensureRelayNativeDepsCacheCommand(
  ...
  // Why grep the sibling's manifest: an older Kingu pinned different versions, and a
...
/**
 * Every symlinked `node_modules` under `~/.kingu-remote/`, as its raw target.
 *
