/**
 * The version-directory garbage collector, shared by the relay and kingud.
 *
...
// eventually drain. There is no kingud equivalent — kingud has never shipped without one.
...
export type RemoteInstallGcOptions = {
   ...
   * (not absolute path). kingud passes its active and previous versions: the previous one is
