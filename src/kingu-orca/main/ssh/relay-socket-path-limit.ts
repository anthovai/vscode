 ...
 *
 * The default endpoint is `$HOME/.kingu-remote/relay-<fullVersion>/relay-<id>.sock`,
...
export const SHORT_RELAY_SOCKET_DIR_PREFIX = '/tmp/.kingu-relay-'
 ...
 * directories in `$HOME/.kingu-remote` so one sweep pattern covers both bases.
 *
 ...
 * Kingu build would bind the exact path the previous build's relay still holds. The
...
const SHORT_DIR_MARKER = 'KINGU-RELAY-SHORT-SOCKET-DIR'
