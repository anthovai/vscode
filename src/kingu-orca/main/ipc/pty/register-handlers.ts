...
import { ensureLinuxTerminalKinguCliShimDir } from '../../cli/linux-terminal-kingu-cli-shim'
...
export function registerPtyHandlers(
  ...
  if (process.platform === 'linux') {
    ...
    if (appEnvironment.isPackaged()) {
      ensureLinuxTerminalKinguCliShimDir({ userDataPath: appEnvironment.getPath('userData') })
    }
  }
