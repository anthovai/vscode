...
const snapshot: KeybindingFileSnapshot = {
  path: '/Users/example/.kingu/keybindings.json',
  platform: 'darwin',
  exists: true,
  overrides: {},
  commonOverrides: {},
...
describe('registerKeybindingHandlers', () => {
  ...
  it('reconciles plugin command conflicts after a shortcut edit', () => {
    ...
    expect(
      getHandler('keybindings:setAction')(
        {},
        {
          actionId: 'plugin:kingu-samples.tasks/open',
  ...
  it('authorizes the keybindings file before opening it outside Kingu', async () => {
