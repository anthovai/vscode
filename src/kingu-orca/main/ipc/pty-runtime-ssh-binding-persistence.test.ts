...
describe('registerPtyHandlers', () => {
  ...
  it('strips runtime-owned SSH pane env when remote agent hooks are disabled', async () => {
    ...
    const savedRemoteHooks = process.env.KINGU_FEATURE_REMOTE_AGENT_HOOKS
    ...
    try {
      ...
      await spawnController.spawn({
        ...
        env: {
          FOO: 'bar',
          KINGU_PANE_KEY: makePaneKey('tab-remote', leafId),
          KINGU_TAB_ID: 'tab-remote',
          KINGU_WORKTREE_ID: 'wt-remote'
        },
      ...
      if (savedRemoteHooks === undefined) {
        ...
        process.env.KINGU_FEATURE_REMOTE_AGENT_HOOKS = savedRemoteHooks
      }
