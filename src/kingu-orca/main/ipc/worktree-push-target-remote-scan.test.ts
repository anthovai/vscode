...
const SSH_FORK = 'git@github.com:contributor/kingu.git'
const HTTPS_FORK = 'https://github.com/contributor/kingu.git'
const GITLAB_FORK = 'https://gitlab.com/contributor/kingu.git'
const UPSTREAM = 'https://github.com/anthovai/kingu-intelligence.git'
...
const fiftyEightRemotes: RemoteRow[] = [
  ...
  { name: 'pr-contributor-kingu', fetchUrl: SSH_FORK }
]
...
const matrix: { name: string; remotes: RemoteRow[]; lookupUrl: string }[] = [
  ...
  },
  {
    ...
    remotes: [{ name: 'gitlab-fork', fetchUrl: GITLAB_FORK }],
    lookupUrl: 'https://bitbucket.org/contributor/kingu.git'
  }
]
