...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (KINGU_E2E_HEADLESS keeps a live but
...
// churn to Kingu just to observe a handful of shallow paths. The replacements
...
// Kingu's own worktree operations notify the renderer directly.
