...
export function resolveWatcherProcessEntryPath(
  ...
  // Why asar and not isPackaged: kingud is a packaged non-Electron host whose app root
  // holds kingud.js and this child side by side. Only the asar layout nests it under
