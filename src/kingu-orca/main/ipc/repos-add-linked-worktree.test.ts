...
const MAIN_CHECKOUT = '/Users/dev/projects/kingu'
const LINKED_WORKTREE = '/Users/dev/kingu/workspaces/kingu/pr-3235'
...
describe('repos:add with git worktrees', () => {
  ...
  it('matches the tracked main checkout across path separator differences', async () => {
    mockStore.getRepos.mockReturnValue([
      { ...trackedMainRepo(), path: 'C:\\Users\\dev\\projects\\kingu' } as Repo
    ])
    getLinkedWorktreeMainRepoRootMock.mockReturnValue('C:/Users/dev/projects/kingu')
