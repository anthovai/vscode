...
function makeRuntime(): { runtime: KinguRuntimeService; writes: string[] } {
  const writes: string[] = []
...
function syncGraph(runtime: KinguRuntimeService): void {
...
function register(runtime: KinguRuntimeService, incarnationId: string): void {
