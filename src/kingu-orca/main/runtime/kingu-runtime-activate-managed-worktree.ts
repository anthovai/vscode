...
import { KinguRuntimeWithListManagedWorktrees } from './kingu-runtime-list-managed-worktrees'
...
export class KinguRuntimeWithActivateManagedWorktree extends KinguRuntimeWithListManagedWorktrees {
  async activateManagedWorktree(
     ...
     *  renderer holds the sleeping records (headless `kingu serve`), so nothing
