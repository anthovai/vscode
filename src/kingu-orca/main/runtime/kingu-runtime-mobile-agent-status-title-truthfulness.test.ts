...
async function createRuntime(rows: AgentStatusIpcPayload[] = []): Promise<KinguRuntimeService> {
...
function publishRendererWorkingPane(runtime: KinguRuntimeService, paneTitle: string): void {
...
function publishRendererReleasedPane(runtime: KinguRuntimeService, title: string): void {
  runtime.attachWindow(1)
  runtime.syncWindowGraph(1, {
    tabs: [
      {
