...
import type { KinguRuntimeRpcServerOptions } from './runtime-rpc/runtime-rpc-pairing-types'
...
export class KinguRuntimeRpcServer extends RuntimeRpcShutdown {
  constructor(options: KinguRuntimeRpcServerOptions) {
    super(options)
  }
}
