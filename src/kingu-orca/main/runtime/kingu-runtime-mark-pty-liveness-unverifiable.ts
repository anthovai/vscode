...
import { KinguRuntimeWithOnPtyExit } from './kingu-runtime-on-pty-exit'
import type { PtyLivenessVerdict } from '../../shared/pty-liveness-verdict'
import type { DriverState } from './kingu-runtime-core'
...
export class KinguRuntimeWithMarkPtyLivenessUnverifiable extends KinguRuntimeWithOnPtyExit {
  /**
  ...
  /**
   * Records that Kingu asked this PTY to stop — a close, a stop, a teardown.
   *
