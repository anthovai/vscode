...
import { KinguRuntimeWithProveRecoveredStructuredTuiPtyProcess } from './kingu-runtime-prove-recovered-structured-tui-pty-process'
...
import { isPathWithinDirectory } from './kingu-runtime-core'

export class KinguRuntimeWithStopStructuredSessionProcess extends KinguRuntimeWithProveRecoveredStructuredTuiPtyProcess {
