...
import { KinguRuntimeWithCreateTerminalSideEffectCommandCodeDetector } from './kingu-runtime-create-terminal-side-effect-command-code-detector'
import type { AgentStatus } from '../../shared/agent-detection'
import { findLastCompleteOscTitleRange } from './kingu-runtime-core'
...
export class KinguRuntimeWithRecordAgentPromptLifecycleState extends KinguRuntimeWithCreateTerminalSideEffectCommandCodeDetector {
