...
import { KinguRuntimeWithGetOrchestrationDispatchAuthority } from './kingu-runtime-get-orchestration-dispatch-authority'
import {
  recentTerminalOutputIncludesPath,
  recentTerminalPathCandidatesIncludePath
} from './terminal-output-path-candidates'
import type { ApplyLayoutResult, DriverState } from './kingu-runtime-core'
import { clampTerminalViewport } from './terminal-viewport'

export class KinguRuntimeWithHasRecentTerminalOutputPath extends KinguRuntimeWithGetOrchestrationDispatchAuthority {
