...
import { KinguRuntimeWithHandleMobileUnsubscribe } from './kingu-runtime-handle-mobile-unsubscribe'

export class KinguRuntimeWithApplyMobileDisplayMode extends KinguRuntimeWithHandleMobileUnsubscribe {
