 ...
 * called solely from `KinguRuntimeService.closeTerminal` (the explicit user-close IPC).
...
function registerTeam(runtime: KinguRuntimeService, ptyId: string, leaderHandle: string): void {
