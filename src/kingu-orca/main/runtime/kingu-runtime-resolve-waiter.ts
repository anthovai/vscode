...
import { KinguRuntimeWithDeliverPendingMessages } from './kingu-runtime-deliver-pending-messages'
...
export class KinguRuntimeWithResolveWaiter extends KinguRuntimeWithDeliverPendingMessages {
