...
import { KinguRuntimeWithSyncWindowGraph } from './kingu-runtime-sync-window-graph'
...
export class KinguRuntimeWithCollectMobileVisibleGraphChangedWorktrees extends KinguRuntimeWithSyncWindowGraph {
  ...
  supportsAuthoritativeSessionTabsInventory(): boolean {
    return process.env.KINGU_E2E_DISABLE_AUTHORITATIVE_SESSION_TABS_INVENTORY !== '1'
  }
