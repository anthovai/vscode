...
import { KinguRuntimeWithAgentPromptRequestCorrelation } from './kingu-runtime-agent-prompt-request-correlation'
...
export class KinguRuntimeWithResolveAuthoritativeTerminalWaitPermission extends KinguRuntimeWithAgentPromptRequestCorrelation {
