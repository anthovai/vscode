...
import { KinguRuntimeWithGetUnpersistedTrackedTitleForPty } from './kingu-runtime-get-unpersisted-tracked-title-for-pty'
...
export class KinguRuntimeWithApplyTrackedPtyTitle extends KinguRuntimeWithGetUnpersistedTrackedTitleForPty {
