...
import { KinguRuntimeWithStopStructuredSessionProcess } from './kingu-runtime-stop-structured-session-process'
...
export class KinguRuntimeWithResolveRecoveredStructuredTuiTranscript extends KinguRuntimeWithStopStructuredSessionProcess {
