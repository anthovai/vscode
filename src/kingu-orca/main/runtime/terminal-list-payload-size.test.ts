...
const WORKTREE_PATH = '/Users/dev/kingu/workspaces/kingu/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — kingu/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): KinguRuntimeService {
