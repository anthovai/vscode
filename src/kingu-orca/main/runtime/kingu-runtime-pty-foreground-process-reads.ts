...
import { KinguRuntimeWithStateFields } from './kingu-runtime-state-fields'
import {
...
export class KinguRuntimeWithPtyForegroundProcessReads extends KinguRuntimeWithStateFields {
