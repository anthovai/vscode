...
import { KinguRuntimeWithAdoptTerminalOrphansFromInventory } from './kingu-runtime-adopt-terminal-orphans-from-inventory'
import type {
...
import { TERMINAL_INTERACTIVE_WAIT_PROBE_TIMEOUT_MS } from './kingu-runtime-core'
...
export class KinguRuntimeWithGetTerminalInteractiveWait extends KinguRuntimeWithAdoptTerminalOrphansFromInventory {
