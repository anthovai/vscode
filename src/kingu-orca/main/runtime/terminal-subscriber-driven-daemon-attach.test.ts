 ...
 *
 * Harness: real KinguRuntimeService + real TERMINAL_METHODS multiplex handler,
 ...
 * assertion also holds for headless `kingu serve`.
 */
...
function startMultiplex(runtime: KinguRuntimeService, connectionId = 'conn-desktop') {
