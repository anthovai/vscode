...
import { KinguRuntimeWithApplyLayout } from './kingu-runtime-apply-layout'

export class KinguRuntimeWithHandleMobileSubscribe extends KinguRuntimeWithApplyLayout {
