...
import type { WorkspaceSessionState } from '../kingu-runtime-test-mocks.spec'
import {
  HEADLESS_LEAF_ID,
...
import { publishLegacyWorkerReveal } from '../kingu-runtime-test-scenario-builders.spec'

describe('KinguRuntimeService', () => {
  it('recovers exported KINGU_TERMINAL_HANDLE from discovered live PTY sessions', async () => {
  ...
  it('reveals one exact live legacy worker without stealing focus', async () => {
    ...
    const runtime = new KinguRuntimeService({ ...runtimeStore, flushOrThrow } as never, undefined, {
