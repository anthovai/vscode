...
describe('KinguRuntimeService', () => {
  ...
  describe('stale terminal handle resolution (#7718)', () => {
    function syncSingleTerminalGraph(runtime: KinguRuntimeService, ptyId: string): void {
    ...
    function issueLeafHandle(runtime: KinguRuntimeService, ptyId: string): string {
