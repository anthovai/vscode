...
import { KinguRuntimeService, listWorktrees } from '../kingu-runtime-test-mocks.spec'
import {
  HEADLESS_LEAF_ID,
...
describe('KinguRuntimeService', () => {
  ...
  it('attaches inline agent rows from the latest OSC 9999 status', async () => {
    const runtime = new KinguRuntimeService(store, undefined, makeAgentStatusStoreWiring().deps)
