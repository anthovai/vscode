...
import { KinguRuntimeWithScheduleWaitBlockedCheck } from './kingu-runtime-schedule-wait-blocked-check'
...
export class KinguRuntimeWithEmitDaemonPtyTransientFact extends KinguRuntimeWithScheduleWaitBlockedCheck {
  ...
  getTerminalSideEffectSnapshot(ptyId: string): TerminalSideEffectBatch | null {
    ...
    // tracker title Kingu synthesized from hooks — but with no tracker title it is the pane's
