...
import { KinguRuntimeWithResolveAuthoritativeTerminalWaitPermission } from './kingu-runtime-resolve-authoritative-terminal-wait-permission'
...
export class KinguRuntimeWithWriteTerminalAgentPrompt extends KinguRuntimeWithResolveAuthoritativeTerminalWaitPermission {
  protected async writeTerminalAgentPrompt(
    ...
    // receipt; they must not fail a Dispatch merely because Kingu cannot prove
