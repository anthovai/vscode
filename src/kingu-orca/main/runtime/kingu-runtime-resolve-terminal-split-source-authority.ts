...
import { KinguRuntimeWithSplitPtyBackedTerminal } from './kingu-runtime-split-pty-backed-terminal'
import {
...
export class KinguRuntimeWithResolveTerminalSplitSourceAuthority extends KinguRuntimeWithSplitPtyBackedTerminal {
  ...
  async prepareClaudeAgentTeamsLeader(args: {
    ...
    if (!handle) {
      throw new Error('claude_agent_teams_requires_kingu_terminal')
    }
