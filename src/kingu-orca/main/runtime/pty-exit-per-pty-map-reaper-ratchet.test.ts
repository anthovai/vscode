...
const REAPER_MODULE = 'src/main/runtime/kingu-runtime-on-pty-exit.ts'
...
const CLEARED_BY_REAPER_HELPER: Record<string, { helper: string; module: string }> = {
  waitBlockedCheckStateByPtyId: {
    ...
    module: 'src/main/runtime/kingu-runtime-schedule-wait-blocked-check.ts'
  },
  ptyTitleTrackersByPtyId: {
    helper: 'disposePtyTitleTracker',
    module: 'src/main/runtime/kingu-runtime-apply-tracked-pty-title.ts'
  },
  agentPromptLifecycleByPtyId: {
    helper: 'advancePtyLifecycleGeneration',
    module: 'src/main/runtime/kingu-runtime-record-agent-prompt-lifecycle-state.ts'
  },
...
function ptyKeyedFieldNames(): string[] {
  const runtime = new KinguRuntimeService() as unknown as Record<string, unknown>
