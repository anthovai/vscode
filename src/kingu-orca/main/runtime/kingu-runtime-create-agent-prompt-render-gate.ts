...
import { KinguRuntimeWithWriteTerminalAgentPrompt } from './kingu-runtime-write-terminal-agent-prompt'
import {
...
export class KinguRuntimeWithCreateAgentPromptRenderGate extends KinguRuntimeWithWriteTerminalAgentPrompt {
