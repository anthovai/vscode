...
// Captured verbatim from cursor-agent 2026.08.11-e8db854 driven through Kingu.
...
describe('worker-show interactive wait (STA-3714, STA-4513)', () => {
  ...
  it('omits the field entirely for a worker it could not verify', async () => {
    // Why not null: null is a claim that Kingu looked. A replaced process is never looked at,
