...
function runtime(cleanups = new Map<string, () => void>()): KinguRuntimeService {
  return {
...
function attachLease(hostRuntime: KinguRuntimeService): BrowserHostLease {
...
function grantExecutionHost(
  hostRuntime: KinguRuntimeService,
