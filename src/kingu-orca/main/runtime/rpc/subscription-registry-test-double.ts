import type { SubscriptionRegistration } from '../kingu-runtime'
...
/**
 * Faithful double of the runtime subscription registry (`KinguRuntimeService`,
 ...
 * `kingu-runtime.test.ts` are what pin the real behavior; these doubles only pin routing.
 *
