...
// a real KinguRuntimeService, because a relay drop reaches the phone through the predicate.
...
function makeRelayDroppedRuntime(): KinguRuntimeService {
  const real = new KinguRuntimeService()
...
function createRuntime(real: KinguRuntimeService): {
