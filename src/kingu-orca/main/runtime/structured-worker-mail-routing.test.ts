...
const { KinguRuntimeWithAdoptTerminalOrphansFromInventory } =
  await import('./kingu-runtime-adopt-terminal-orphans-from-inventory')
const {
...
const prototype = KinguRuntimeWithAdoptTerminalOrphansFromInventory.prototype
