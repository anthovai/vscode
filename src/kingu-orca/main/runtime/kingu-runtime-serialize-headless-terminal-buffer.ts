...
import { KinguRuntimeWithVisibleSnapshotPreview } from './kingu-runtime-visible-snapshot-preview'
...
export class KinguRuntimeWithSerializeHeadlessTerminalBuffer extends KinguRuntimeWithVisibleSnapshotPreview {
