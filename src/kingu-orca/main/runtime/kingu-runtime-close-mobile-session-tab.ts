...
import { KinguRuntimeWithRefuseUnattributedMobileSessionTabClose } from './kingu-runtime-refuse-unattributed-mobile-session-tab-close'
import type {
...
export class KinguRuntimeWithCloseMobileSessionTab extends KinguRuntimeWithRefuseUnattributedMobileSessionTabClose {
