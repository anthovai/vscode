...
import { KinguRuntimeWithSerializeTerminalBufferFromAvailableState } from './kingu-runtime-serialize-terminal-buffer-from-available-state'
...
import type { RuntimeTerminalProjection } from './kingu-runtime-core'
import { DEFAULT_TERMINAL_READ_LIMIT } from './terminal-tail-limits'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { projectTerminalTailLines } from './kingu-runtime-terminal-projection'

export class KinguRuntimeWithCaptureProviderTerminalBuffer extends KinguRuntimeWithSerializeTerminalBufferFromAvailableState {
