...
import { KinguRuntimeWithRegisterPty } from './kingu-runtime-register-pty'
...
export class KinguRuntimeWithPreparePtyExecutionContext extends KinguRuntimeWithRegisterPty {
