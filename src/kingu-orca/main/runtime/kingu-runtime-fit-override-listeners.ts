...
import { KinguRuntimeWithStopRequestedPtyIds } from './kingu-runtime-stop-requested-pty-ids'
...
export class KinguRuntimeWithFitOverrideListeners extends KinguRuntimeWithStopRequestedPtyIds {
