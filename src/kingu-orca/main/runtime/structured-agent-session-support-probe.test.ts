...
function stubStructuredHostInstall(runtime: KinguRuntimeService): {
...
function createRuntime(location: TestLocation): KinguRuntimeService {
  const runtime = new KinguRuntimeService({ getSettings: () => ({}) } as never)
