...
function syncSshSplit(runtime: KinguRuntimeService, snapshot: RuntimeMobileSessionTabsSnapshot) {
...
describe('KinguRuntimeService terminal retirement host partitioning (STA-3463)', () => {
  ...
  it('waits for provider retirement on a direct worktree stop', async () => {
    ...
    const runtime = new KinguRuntimeService(harness.store)
