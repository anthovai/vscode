/**
 * Drives the real push seam: a real KinguRuntimeService, the real lease registry, the real page
...
function attachHost(runtime: KinguRuntimeService, browserHostClientId: string) {
