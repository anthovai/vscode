...
import { KinguRuntimeWithResolveMobileSessionTerminalCommand } from './kingu-runtime-resolve-mobile-session-terminal-command'
...
export class KinguRuntimeWithCreateRuntimeOwnedMobileSessionTerminal extends KinguRuntimeWithResolveMobileSessionTerminalCommand {
