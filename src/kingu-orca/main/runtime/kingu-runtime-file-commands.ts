...
import { KinguRuntimeWithPreservedBranchCleanup } from './kingu-runtime-preserved-branch-cleanup'
import { RuntimeFileCommands } from './kingu-runtime-files'
...
import { RuntimeGitCommands } from './kingu-runtime-git'
...
export class KinguRuntimeWithFileCommands extends KinguRuntimeWithPreservedBranchCleanup {
