...
import { KinguRuntimeWithPreparePtyExecutionContext } from './kingu-runtime-prepare-pty-execution-context'
...
export class KinguRuntimeWithOnPtyData extends KinguRuntimeWithPreparePtyExecutionContext {
  onPtyData(
    ptyId: string,
    data: string,
    at: number,
