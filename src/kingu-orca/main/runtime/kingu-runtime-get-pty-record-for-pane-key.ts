...
import { KinguRuntimeWithPruneMobileSessionTabGroupLayout } from './kingu-runtime-prune-mobile-session-tab-group-layout'
...
export class KinguRuntimeWithGetPtyRecordForPaneKey extends KinguRuntimeWithPruneMobileSessionTabGroupLayout {
