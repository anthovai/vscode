...
import { KinguRuntimeWithTouchMobileSessionTabsForWorktree } from './kingu-runtime-touch-mobile-session-tabs-for-worktree'
...
export class KinguRuntimeWithPersistTerminalSurfaceRetirements extends KinguRuntimeWithTouchMobileSessionTabsForWorktree {
  /**
