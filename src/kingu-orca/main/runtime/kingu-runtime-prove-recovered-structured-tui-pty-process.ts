...
import { KinguRuntimeWithGetWorktreePs } from './kingu-runtime-get-worktree-ps'
...
export class KinguRuntimeWithProveRecoveredStructuredTuiPtyProcess extends KinguRuntimeWithGetWorktreePs {
