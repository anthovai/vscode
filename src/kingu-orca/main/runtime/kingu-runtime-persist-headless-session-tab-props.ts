...
import { KinguRuntimeWithCloseHeadlessMobileTerminalTab } from './kingu-runtime-close-headless-mobile-terminal-tab'
...
export class KinguRuntimeWithPersistHeadlessSessionTabProps extends KinguRuntimeWithCloseHeadlessMobileTerminalTab {
