...
import { KinguRuntimeWithSyncMobileSessionTabs } from './kingu-runtime-sync-mobile-session-tabs'
import type {
...
export class KinguRuntimeWithMergePreservedHeadlessMobileSessionTabs extends KinguRuntimeWithSyncMobileSessionTabs {
