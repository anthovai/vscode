...
import { KinguRuntimeWithPersistHeadlessTerminalTitle } from './kingu-runtime-persist-headless-terminal-title'
import {
...
export class KinguRuntimeWithResolveKnownWorkspaceFileTarget extends KinguRuntimeWithPersistHeadlessTerminalTitle {
  ...
  // RPC, but agents need their own handle at spawn time (via KINGU_TERMINAL_HANDLE
  ...
  protected adoptControllerTerminalHandle(
    ...
    // original KINGU_TERMINAL_HANDLE, but the runtime's in-memory map is gone.
