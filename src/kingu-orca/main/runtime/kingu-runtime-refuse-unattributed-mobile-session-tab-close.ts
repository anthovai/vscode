...
import { KinguRuntimeWithApplyMobileSessionTabNavigation } from './kingu-runtime-apply-mobile-session-tab-navigation'
import type { RuntimeMobileSessionTabCloseResult } from '../../shared/runtime-types'

export class KinguRuntimeWithRefuseUnattributedMobileSessionTabClose extends KinguRuntimeWithApplyMobileSessionTabNavigation {
