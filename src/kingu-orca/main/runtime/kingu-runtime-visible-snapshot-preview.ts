...
import { KinguRuntimeWithCaptureProviderTerminalBuffer } from './kingu-runtime-capture-provider-terminal-buffer'
...
import { projectTerminalVisibleLines } from './kingu-runtime-terminal-projection'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { withTimeout } from './runtime-async-boundaries'

export class KinguRuntimeWithVisibleSnapshotPreview extends KinguRuntimeWithCaptureProviderTerminalBuffer {
