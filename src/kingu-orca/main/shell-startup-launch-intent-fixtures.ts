/**
 * The two launch intents Kingu's call sites choose between, resolved through the
...
/** A pane Kingu will write a startup command into. */
...
/** A pane carrying an Kingu overlay but no startup command. */
export const OVERLAY_ONLY_FEATURES = selectShellStartupFeatures({
  shellPath: 'zsh',
  env: { KINGU_CODEX_HOME: '/tmp/kingu-codex-home' },
