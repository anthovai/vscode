...
export const TEST_REPO_KINGU_YAML_PATH = join(TEST_REPO_PATH, 'kingu.yaml')
export const TEST_WORKTREE_KINGU_YAML_PATH = join(TEST_WORKTREE_PATH, 'kingu.yaml')
export const TEST_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.kingu', 'issue-command')
