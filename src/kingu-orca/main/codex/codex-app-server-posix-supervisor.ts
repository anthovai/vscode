...
const spec = JSON.parse(Buffer.from(process.env.KINGU_PROVIDER_SUPERVISOR_SPEC, 'base64').toString())
const childEnv = { ...process.env }
delete childEnv.KINGU_PROVIDER_SUPERVISOR_SPEC
...
timer = setInterval(() => {
  ...
  // this process group no longer has a live Kingu owner.
...
export function supervisedPosixLaunch(
  ...
  return {
    ...
    env: {
      ...
      KINGU_PROVIDER_SUPERVISOR_SPEC: supervisorSpec
    }
  }
}
