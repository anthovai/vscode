 ...
 * omitted field through the `config.toml` it was started with, and Kingu mirrors the user's
 ...
 * untouched profile resolves to the default Kingu ships, which is the bypass flag.
 *
