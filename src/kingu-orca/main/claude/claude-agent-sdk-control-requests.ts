...
/**
 * Run one native Query control method under Kingu's deadline and error classification.
 *
...
/** The native control surface Kingu drives, one method per Query control request. */
