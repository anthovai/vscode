...
// user-initiated network path from the error-tracking lane to Kingu infra. The per-bundle
...
export type CollectBundleOptions = {
  ...
  readonly kinguChannel: 'stable' | 'rc' | 'dev'
}
...
type BundleHeader = {
  ...
  readonly kingu_channel: 'stable' | 'rc' | 'dev'
...
export function collectBundle(opts: CollectBundleOptions): CollectedBundle {
  ...
  const header: BundleHeader = {
    ...
    kingu_channel: opts.kinguChannel,
