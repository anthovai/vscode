...
export const KINGU_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV = 'KINGU_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined KINGU_CODEX_LAUNCH_PREFLIGHT call %${KINGU_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%KINGU_CODEX_LAUNCH_PREFLIGHT%%${KINGU_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Kingu detects.
