// Opt in: KINGU_LOCAL_METADATA_PRUNE_BENCH=1 pnpm test src/main/persistence/tracking-repos/local-worktree-metadata-batch-pruning.bench.test.ts
...
const describeBench = process.env.KINGU_LOCAL_METADATA_PRUNE_BENCH ? describe : describe.skip
