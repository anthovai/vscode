...
// through Kingu. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('Kingu'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'kingu-stats.json')
}
