...
export const ISSUE_QUERY = `
  query KinguAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query KinguAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query KinguAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query KinguAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query KinguAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query KinguAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const INVERSE_RELATIONS_QUERY = `
  query KinguAgentLinearIssueInverseRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
