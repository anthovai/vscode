...
describe('self-initiated tree kill breadcrumb', () => {
  it('separates an Kingu-issued tree kill from an external kill of the same shape', async () => {
    // Arm A — Kingu issues the kill through its own taskkill choke point.
    ...
    // Arm B — identical crash, nobody inside Kingu issued a kill.
