...
const ATOM_FEED_URL = 'https://github.com/anthovai/kingu-intelligence/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/anthovai/kingu-intelligence/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/anthovai\/kingu\/releases\/tag\/([^"]+)"/g
...
async function getReleaseAssetReadiness(tag: string, assetName: string): Promise<ReleaseReadiness> {
  ...
  const isGitHubReleaseAsset =
    ...
    (isRelativeAsset ||
      /^https:\/\/github\.com\/anthovai\/kingu\/releases\/download\//i.test(assetName))
