...
function describeLinuxBackendGap(): string | null {
  ...
  return backend === 'basic_text'
    ? 'Secrets are obfuscated with a built-in key, not protected by the OS keyring. Install and unlock gnome-keyring or kwallet, then restart Kingu, to seal them properly.'
    : null
}
