 ...
 * Neither of these hosts has that child: kingud ships only the watcher and daemon
 * entries beside `kingud.js`, and the relay's AI Vault sidecar runs the remote
