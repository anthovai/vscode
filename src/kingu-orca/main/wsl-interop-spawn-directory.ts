 ...
 * `lpCurrentDirectory`, and NULL means *inherit the parent's*. Kingu launched by
 * `kingu-ide` from a WSL shell inherits `\\wsl.localhost\<distro>\...\<worktree>`
