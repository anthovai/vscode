...
import { SESSIONS_LIST_SHOW_EMPTY_DEFAULT_GROUPS_SETTING, SESSIONS_LIST_SHOW_SUBAGENTS_SETTING, SESSIONS_LIST_SHOW_UNREAD_IN_COLLAPSED_SECTIONS_SETTING } from './views/sessionsList.js';
...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	...
	properties: {
		...
		[SESSIONS_LIST_SHOW_SUBAGENTS_SETTING]: {
			type: 'boolean',
			description: localize('sessions.list.showSubagents', "Controls whether the subagents a chat starts are listed under it in the sessions list."),
			default: true,
		},
