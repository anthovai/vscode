...
export const discoverySourceLabel: Record<ExternalDiscoverySource, string> = {
	...
	[ExternalDiscoverySource.Copilot]: localize('mcp.discovery.source.copilot', "Arkai CLI"),
...
export const discoverySourceSettingsLabel: Record<ExternalDiscoverySource, string> = {
	...
	[ExternalDiscoverySource.Copilot]: localize('mcp.discovery.source.copilot.config', "Arkai CLI configuration (`mcp-config.json` in `COPILOT_HOME`, or `~/.copilot/mcp-config.json` when unset)"),
