						...
						translations: {
							...
							items: {
								...
								properties: {
									id: {
										type: 'string',
										description: localize('vscode.extension.contributes.localizations.translations.id', "Id of Kingu or Extension for which this translation is contributed to. Id of Kingu is always `vscode` and of extension should be in format `publisherId.extensionName`."),
