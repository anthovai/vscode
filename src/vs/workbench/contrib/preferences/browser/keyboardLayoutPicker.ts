...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Kingu in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Kingu and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
