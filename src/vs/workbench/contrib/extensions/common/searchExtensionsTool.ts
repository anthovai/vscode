...
export const SearchExtensionsToolData: IToolData = {
	...
	displayName: localize('searchExtensionsTool.displayName', 'Search Snaps'),
	...
	userDescription: localize('searchExtensionsTool.userDescription', 'Search for VS Code snaps'),
