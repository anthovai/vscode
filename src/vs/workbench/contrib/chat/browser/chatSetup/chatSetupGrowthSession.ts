...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try Arkai"),
			description: localize('growthSession.description', "Arkai is available. Try it for free."),
