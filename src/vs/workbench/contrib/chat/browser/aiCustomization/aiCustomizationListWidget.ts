...
export class AICustomizationListWidget extends Disposable {
	...
	private groupMatchedItems(matchedItems: IAICustomizationListItem[]): void {
		const groups: ICustomizationItemGroup[] = [
			...
			{ groupKey: PromptsStorage.extension, label: localize('extensionGroup', "Snaps"), icon: extensionIcon, description: localize('extensionGroupDescription', "Read-only customizations provided by installed extensions."), items: [] },
