...
export const chatWorkingProgressStableIconForeground = registerColor(
	...
	localize('chat.workingProgressStableIconForeground', 'Foreground color of the Stable Kingu icon in the chat working progress indicator.'));
...
export const chatWorkingProgressInsidersIconForeground = registerColor(
	...
	localize('chat.workingProgressInsidersIconForeground', 'Foreground color of the Insiders Kingu icon in the chat working progress indicator.'));
