...
export const hookFileSchema: IJSONSchema = {
	...
	type: 'object',
	description: nls.localize('hookFile.description', 'Arkai hook configuration file. Hooks enable executing custom shell commands at strategic points in an agent\'s workflow.'),
	additionalProperties: true,
	required: ['hooks'],
	properties: {
		hooks: {
