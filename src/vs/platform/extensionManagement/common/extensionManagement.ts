...
export const ExtensionsLocalizedLabel = localize2('extensions', "Snap");
	...
	.registerConfiguration({
		...
		properties: {
			[AllowedExtensionsConfigKey]: {
				...
				type: 'object',
				markdownDescription: localize('extensions.allowed', "Specify a list of snaps that are allowed to use. This helps maintain a secure and consistent development environment by restricting the use of unauthorized snaps. For more information on how to configure this setting, please visit the [Configure Allowed Snaps](https://aka.ms/vscode/enterprise/snaps/allowed) section."),
				default: '*',
				defaultSnippets: [{
					body: {},
					description: localize('extensions.allowed.none', "No snaps are allowed."),
				}, {
					body: {
						'*': true
					},
					description: localize('extensions.allowed.all', "All snaps are allowed."),
				}],
				...
				policy: {
					...
					localization: {
						description: {
							...
							value: localize('extensions.allowed.policy', "Specify a list of snaps that are allowed to use. This helps maintain a secure and consistent development environment by restricting the use of unauthorized snaps. More information: https://aka.ms/vscode/enterprise/snaps/allowed"),
						}
					}
				},
				...
				patternProperties: {
						...
						anyOf: [
							{
								...
								description: localize('extensions.allow.description', "Allow or disallow the snap."),
								enumDescriptions: [
									localize('extensions.allowed.enable.desc', "Snap is allowed."),
									localize('extensions.allowed.disable.desc', "Snap is not allowed."),
									localize('extensions.allowed.disable.stable.desc', "Allow only stable versions of the snap."),
								],
							},
							{
								type: 'array',
					...
					[EXTENSION_PUBLISHER_IDENTIFIER_PATTERN]: {
						type: ['boolean', 'string'],
						enum: [true, false, 'stable'],
						description: localize('extension.publisher.allow.description', "Allow or disallow all snaps from the publisher."),
						enumDescriptions: [
							localize('extensions.publisher.allowed.enable.desc', "All snaps from the publisher are allowed."),
							localize('extensions.publisher.allowed.disable.desc', "All snaps from the publisher are not allowed."),
							localize('extensions.publisher.allowed.disable.stable.desc', "Allow only stable versions of the snaps from the publisher."),
						],
					},
					'\\*': {
						type: 'boolean',
						enum: [true, false],
						description: localize('extensions.allow.all.description', "Allow or disallow all snaps."),
						enumDescriptions: [
							localize('extensions.allow.all.enable', "Allow all snaps."),
							localize('extensions.allow.all.disable', "Disallow all snaps.")
						],
					}
				}
			}
