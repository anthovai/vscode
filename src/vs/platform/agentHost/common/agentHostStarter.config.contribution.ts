			...
			policy: {
				...
				localization: {
					description: {
						...
						value: nls.localize('chat.agentHost.claudeAgent.enabled.policy', "Enable Claude Agent sessions in Kingu. Start and resume agentic coding sessions powered by Anthropic Claude Agent SDK directly in the editor. Uses your existing Arkai subscription."),
					}
				}
			},
		},
			...
			policy: {
				...
				localization: {
					description: {
						...
						value: nls.localize('chat.agentHost.codexAgent.enabled.policy', "Enable Codex Agent sessions in Kingu. Start and resume agentic coding sessions powered by OpenAI Codex. Usage can be routed through Arkai or authenticated directly with an OpenAI account."),
					}
				}
			},
		},
			...
			policy: {
				...
				localization: {
					description: {
						...
						value: nls.localize('chat.agentHost.otel.captureIdentity.policy', "Controls whether Arkai OpenTelemetry captures the authenticated account name, operating system username, and machine hostname. Independent of content capture."),
					}
				},
			},
		},
